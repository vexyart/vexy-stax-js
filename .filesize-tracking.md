...
**Total Build Size**: 1,148.46 kB
- `index.html`: 1.24 kB (gzip: 0.59 kB)
- `index-Dlfyt3_3.css`: 3.83 kB (gzip: 1.30 kB)
- `index-D0H6xQ20.js`: 1,143.39 kB (gzip: 291.62 kB) ⚠️ >500 kB warning
...
**Trend**: Bundle size has been remarkably stable for 65+ iterations (26-91), varying by <1 kB despite adding:

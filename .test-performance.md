...
- ⚠️ **Warning**: Total duration >770ms (+11% from baseline)
- 🚨 **Critical**: Total duration >880ms (+27% from baseline)
- ⚠️ **Warning**: Any single suite >2x baseline
- 🚨 **Critical**: Test failures or hangs
...
npm run test:unit 2>&1 | grep -E "^✔ [A-Z]" | sed 's/✔ //' | sort -t'(' -k2 -rn

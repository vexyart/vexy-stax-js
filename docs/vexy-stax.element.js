const It = "srgb", _i = "srgb-linear", br = "linear", it = "srgb";
const ta = "300 es";
function eo(n) {
...
class Wi {
  ...
  static slerpFlat(e, t, i, r, s, a, o) {
    ...
    if (u !== v || l !== f || c !== p || d !== x) {
      ...
      let h = 1 - o;
      if (m < 0.9995) {
        const T = Math.acos(m), y = Math.sin(T);
        h = Math.sin(h * T) / y, o = Math.sin(o * T) / y, l = l * h + f * o, c = c * h + p * o, d = d * h + x * o, u = u * h + v * o;
      } else {
...
const Vr = /* @__PURE__ */ new G(), ra = /* @__PURE__ */ new Wi();
class Be {
  /**
  ...
  multiplyMatrices(e, t) {
    const i = e.elements, r = t.elements, s = this.elements, a = i[0], o = i[3], l = i[6], c = i[1], d = i[4], u = i[7], f = i[2], p = i[5], x = i[8], v = r[0], m = r[3], h = r[6], T = r[1], y = r[4], A = r[7], D = r[2], E = r[5], P = r[8];
    return s[0] = a * v + o * T + l * D, s[3] = a * m + o * y + l * E, s[6] = a * h + o * A + l * P, s[1] = c * v + d * T + u * D, s[4] = c * m + d * y + u * E, s[7] = c * h + d * A + u * P, s[2] = f * v + p * T + x * D, s[5] = f * m + p * y + x * E, s[8] = f * h + p * A + x * P, this;
  }
  /**
...
const kr = /* @__PURE__ */ new Be(), sa = /* @__PURE__ */ new Be().set(
  0.4123908,
  0.3575843,
  0.1804808,
  0.212639,
...
function Qo() {
  const n = {
    ...
    convert: function(r, s, a) {
      return this.enabled === !1 || s === a || !s || !a || (this.spaces[s].transfer === it && (r.r = Mn(r.r), r.g = Mn(r.g), r.b = Mn(r.b)), this.spaces[s].primaries !== this.spaces[a].primaries && (r.applyMatrix3(this.spaces[s].toXYZ), r.applyMatrix3(this.spaces[a].fromXYZ)), this.spaces[a].transfer === it && (r.r = xi(r.r), r.g = xi(r.g), r.b = xi(r.b))), r;
    },
    ...
    getTransfer: function(r) {
      return r === "" ? br : this.spaces[r].transfer;
    },
    ...
    fromWorkingColorSpace: function(r, s) {
      return Vi("ColorManagement: .fromWorkingColorSpace() has been renamed to .workingToColorSpace()."), n.workingToColorSpace(r, s);
    },
    toWorkingColorSpace: function(r, s) {
      return Vi("ColorManagement: .toWorkingColorSpace() has been renamed to .colorSpaceToWorking()."), n.colorSpaceToWorking(r, s);
    }
...
class el {
  ...
  static getDataURL(e, t = "image/png") {
    ...
    if (e instanceof HTMLCanvasElement)
      ...
      Qn === void 0 && (Qn = Gi("canvas")), Qn.width = e.width, Qn.height = e.height;
      const r = Qn.getContext("2d");
      e instanceof ImageData ? r.putImageData(e, 0, 0) : r.drawImage(e, 0, 0, e.width, e.height), i = Qn;
    }
...
class Ps {
   ...
   */
  constructor(e = null) {
    this.isSource = !0, Object.defineProperty(this, "id", { value: tl++ }), this.uuid = Hi(), this.data = e, this.dataReady = !0, this.version = 0;
  }
  /**
...
function Hr(n) {
  return typeof HTMLImageElement < "u" && n instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && n instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && n instanceof ImageBitmap ? el.getDataURL(n) : n.data ? {
...
class _t {
  ...
  setAxisAngleFromRotationMatrix(e) {
    ...
    if (Math.abs(d - f) < 0.01 && Math.abs(u - v) < 0.01 && Math.abs(x - m) < 0.01) {
      ...
      t = Math.PI;
      const y = (c + 1) / 2, A = (p + 1) / 2, D = (h + 1) / 2, E = (d + f) / 4, P = (u + v) / 4, O = (x + m) / 4;
      return y > A && y > D ? y < 0.01 ? (i = 0, r = 0.707106781, s = 0.707106781) : (i = Math.sqrt(y), r = E / i, s = P / i) : A > D ? A < 0.01 ? (i = 0.707106781, r = 0, s = 0.707106781) : (r = Math.sqrt(A), i = E / r, s = O / r) : D < 0.01 ? (i = 0.707106781, r = 0.707106781, s = 0) : (s = Math.sqrt(D), i = P / s, r = O / s), this.set(i, r, s, t), this;
    }
...
class il extends bi {
  ...
  copy(e) {
    ...
    for (let t = 0, i = e.textures.length; t < i; t++) {
      ...
      this.textures[t].source = new Ps(r);
    }
...
class Xi {
  ...
  intersectsTriangle(e) {
    if (this.isEmpty())
      return !1;
    this.getCenter(Ai), ji.subVectors(this.max, Ai), ei.subVectors(e.a, Ai), ti.subVectors(e.b, Ai), ni.subVectors(e.c, Ai), Tn.subVectors(ti, ei), An.subVectors(ni, ti), In.subVectors(ei, ni);
    let t = [
      0,
      -Tn.z,
      Tn.y,
    ...
    return !Xr(t, ei, ti, ni, ji) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !Xr(t, ei, ti, ni, ji)) ? !1 : (Ji.crossVectors(Tn, An), t = [Ji.x, Ji.y, Ji.z], Xr(t, ei, ti, ni, ji));
  }
  /**
...
const hn = [
  ...
  /* @__PURE__ */ new G(),
  /* @__PURE__ */ new G()
], Jt = /* @__PURE__ */ new G(), Zi = /* @__PURE__ */ new Xi(), ei = /* @__PURE__ */ new G(), ti = /* @__PURE__ */ new G(), ni = /* @__PURE__ */ new G(), Tn = /* @__PURE__ */ new G(), An = /* @__PURE__ */ new G(), In = /* @__PURE__ */ new G(), Ai = /* @__PURE__ */ new G(), ji = /* @__PURE__ */ new G(), Ji = /* @__PURE__ */ new G(), Nn = /* @__PURE__ */ new G();
...
const sl = /* @__PURE__ */ new Xi(), wi = /* @__PURE__ */ new G(), qr = /* @__PURE__ */ new G();
class Ds {
  /**
  ...
  setFromPoints(e, t) {
    const i = this.center;
    t !== void 0 ? i.copy(t) : sl.setFromPoints(e).getCenter(i);
    let r = 0;
  ...
  expandByPoint(e) {
    ...
    if (t > this.radius * this.radius) {
      ...
      this.center.addScaledVector(wi, r / i), this.radius += r;
    }
    return this;
  }
  /**
   ...
   */
  union(e) {
    return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (qr.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(wi.copy(e.center).add(qr)), this.expandByPoint(wi.copy(e.center).sub(qr))), this);
  }
  /**
...
const pn = /* @__PURE__ */ new G(), Yr = /* @__PURE__ */ new G(), Qi = /* @__PURE__ */ new G(), wn = /* @__PURE__ */ new G(), $r = /* @__PURE__ */ new G(), er = /* @__PURE__ */ new G(), Kr = /* @__PURE__ */ new G();
class al {
  /**
  ...
  distanceSqToSegment(e, t, i, r) {
    Yr.copy(e).add(t).multiplyScalar(0.5), Qi.copy(t).sub(e).normalize(), wn.copy(this.origin).sub(Yr);
    const s = e.distanceTo(t) * 0.5, a = -this.direction.dot(Qi), o = wn.dot(this.direction), l = -wn.dot(Qi), c = wn.lengthSq(), d = Math.abs(1 - a * a);
    let u, f, p, x;
    if (d > 0)
    ...
    return i && i.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(Yr).addScaledVector(Qi, f), p;
  }
  /**
  ...
  intersectTriangle(e, t, i, r, s) {
    $r.subVectors(t, e), er.subVectors(i, e), Kr.crossVectors($r, er);
    ...
    const l = o * this.direction.dot(er.crossVectors(wn, er));
    if (l < 0)
      return null;
...
class bt {
   ...
   */
  extractRotation(e) {
    const t = this.elements, i = e.elements, r = 1 / ii.setFromMatrixColumn(e, 0).length(), s = 1 / ii.setFromMatrixColumn(e, 1).length(), a = 1 / ii.setFromMatrixColumn(e, 2).length();
  ...
  lookAt(e, t, i) {
    ...
    return Vt.subVectors(e, t), Vt.lengthSq() === 0 && (Vt.z = 1), Vt.normalize(), Cn.crossVectors(i, Vt), Cn.lengthSq() === 0 && (Math.abs(i.z) === 1 ? Vt.x += 1e-4 : Vt.z += 1e-4, Vt.normalize(), Cn.crossVectors(i, Vt)), Cn.normalize(), tr.crossVectors(Vt, Cn), r[0] = Cn.x, r[4] = tr.x, r[8] = Vt.x, r[1] = Cn.y, r[5] = tr.y, r[9] = Vt.y, r[2] = Cn.z, r[6] = tr.z, r[10] = Vt.z, this;
  }
  /**
   ...
   */
  multiplyMatrices(e, t) {
    const i = e.elements, r = t.elements, s = this.elements, a = i[0], o = i[4], l = i[8], c = i[12], d = i[1], u = i[5], f = i[9], p = i[13], x = i[2], v = i[6], m = i[10], h = i[14], T = i[3], y = i[7], A = i[11], D = i[15], E = r[0], P = r[4], O = r[8], M = r[12], S = r[1], L = r[5], z = r[9], H = r[13], q = r[2], K = r[6], Y = r[10], te = r[14], W = r[3], Q = r[7], re = r[11], Me = r[15];
    return s[0] = a * E + o * S + l * q + c * W, s[4] = a * P + o * L + l * K + c * Q, s[8] = a * O + o * z + l * Y + c * re, s[12] = a * M + o * H + l * te + c * Me, s[1] = d * E + u * S + f * q + p * W, s[5] = d * P + u * L + f * K + p * Q, s[9] = d * O + u * z + f * Y + p * re, s[13] = d * M + u * H + f * te + p * Me, s[2] = x * E + v * S + m * q + h * W, s[6] = x * P + v * L + m * K + h * Q, s[10] = x * O + v * z + m * Y + h * re, s[14] = x * M + v * H + m * te + h * Me, s[3] = T * E + y * S + A * q + D * W, s[7] = T * P + y * L + A * K + D * Q, s[11] = T * O + y * z + A * Y + D * re, s[15] = T * M + y * H + A * te + D * Me, this;
  }
  /**
   * Multiplies every component of the matrix by the given scalar.
   *
   ...
   */
  invert() {
    const e = this.elements, t = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], l = e[6], c = e[7], d = e[8], u = e[9], f = e[10], p = e[11], x = e[12], v = e[13], m = e[14], h = e[15], T = u * m * c - v * f * c + v * l * p - o * m * p - u * l * h + o * f * h, y = x * f * c - d * m * c - x * l * p + a * m * p + d * l * h - a * f * h, A = d * v * c - x * u * c + x * o * p - a * v * p - d * o * h + a * u * h, D = x * u * l - d * v * l - x * o * f + a * v * f + d * o * m - a * u * m, E = t * T + i * y + r * A + s * D;
   ...
   */
  compose(e, t, i) {
    const r = this.elements, s = t._x, a = t._y, o = t._z, l = t._w, c = s + s, d = a + a, u = o + o, f = s * c, p = s * d, x = s * u, v = a * d, m = a * u, h = o * u, T = l * c, y = l * d, A = l * u, D = i.x, E = i.y, P = i.z;
    return r[0] = (1 - (v + h)) * D, r[1] = (p + A) * D, r[2] = (x - y) * D, r[3] = 0, r[4] = (p - A) * E, r[5] = (1 - (f + h)) * E, r[6] = (m + T) * E, r[7] = 0, r[8] = (x + y) * P, r[9] = (m - T) * P, r[10] = (1 - (f + v)) * P, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, this;
  }
  /**
  ...
  decompose(e, t, i) {
    ...
    return Qt.elements[0] *= c, Qt.elements[1] *= c, Qt.elements[2] *= c, Qt.elements[4] *= d, Qt.elements[5] *= d, Qt.elements[6] *= d, Qt.elements[8] *= u, Qt.elements[9] *= u, Qt.elements[10] *= u, t.setFromRotationMatrix(Qt), i.x = s, i.y = a, i.z = o, this;
  }
  /**
...
const ii = /* @__PURE__ */ new G(), Qt = /* @__PURE__ */ new bt(), ol = /* @__PURE__ */ new G(0, 0, 0), ll = /* @__PURE__ */ new G(1, 1, 1), Cn = /* @__PURE__ */ new G(), tr = /* @__PURE__ */ new G(), Vt = /* @__PURE__ */ new G(), oa = /* @__PURE__ */ new bt(), la = /* @__PURE__ */ new Wi();
class En {
  /**
   ...
   */
  constructor(e = 0, t = 0, i = 0, r = En.DEFAULT_ORDER) {
  ...
  setFromQuaternion(e, t, i) {
    return oa.makeRotationFromQuaternion(e), this.setFromRotationMatrix(oa, t, i);
  }
  /**
...
let cl = 0;
const ca = /* @__PURE__ */ new G(), ri = /* @__PURE__ */ new Wi(), mn = /* @__PURE__ */ new bt(), nr = /* @__PURE__ */ new G(), Ci = /* @__PURE__ */ new G(), dl = /* @__PURE__ */ new G(), ul = /* @__PURE__ */ new Wi(), da = /* @__PURE__ */ new G(1, 0, 0), ua = /* @__PURE__ */ new G(0, 1, 0), fa = /* @__PURE__ */ new G(0, 0, 1), ha = { type: "added" }, fl = { type: "removed" }, si = { type: "childadded", child: null }, Zr = { type: "childremoved", child: null };
class qt extends bi {
  /**
   * Constructs a new 3D object.
   */
  constructor() {
    super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: cl++ }), this.uuid = Hi(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = qt.DEFAULT_UP.clone();
    const e = new G(), t = new En(), i = new Wi(), r = new G(1, 1, 1);
    function s() {
      i.setFromEuler(t, !1);
    }
    function a() {
  ...
  lookAt(e, t, i) {
    ...
    const r = this.parent;
    this.updateWorldMatrix(!0, !1), Ci.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? mn.lookAt(Ci, nr, this.up) : mn.lookAt(nr, Ci, this.up), this.quaternion.setFromRotationMatrix(mn), r && (mn.extractRotation(r.matrixWorld), ri.setFromRotationMatrix(mn), this.quaternion.premultiply(ri.invert()));
  }
  /**
  ...
  add(e) {
    ...
    return e === this ? (gt("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(ha), si.child = e, this.dispatchEvent(si), si.child = null) : gt("Object3D.add: object not an instance of THREE.Object3D.", e), this);
  }
  /**
  ...
  remove(e) {
    ...
    return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(fl), Zr.child = e, this.dispatchEvent(Zr), Zr.child = null), this;
  }
  /**
   ...
   */
  attach(e) {
    return this.updateWorldMatrix(!0, !1), mn.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(!0, !1), mn.multiply(e.parent.matrixWorld)), e.applyMatrix4(mn), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(!1, !0), e.dispatchEvent(ha), si.child = e, this.dispatchEvent(si), si.child = null, this;
  }
  /**
  ...
  getWorldQuaternion(e) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Ci, e, dl), e;
  }
  /**
   ...
   */
  getWorldScale(e) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Ci, ul, e), e;
  }
  /**
...
const en = /* @__PURE__ */ new G(), xn = /* @__PURE__ */ new G(), jr = /* @__PURE__ */ new G(), gn = /* @__PURE__ */ new G(), ai = /* @__PURE__ */ new G(), oi = /* @__PURE__ */ new G(), pa = /* @__PURE__ */ new G(), Jr = /* @__PURE__ */ new G(), Qr = /* @__PURE__ */ new G(), es = /* @__PURE__ */ new G(), ts = /* @__PURE__ */ new _t(), ns = /* @__PURE__ */ new _t(), is = /* @__PURE__ */ new _t();
class nn {
  /**
  ...
  static getNormal(e, t, i, r) {
    r.subVectors(i, t), en.subVectors(e, t), r.cross(en);
    const s = r.lengthSq();
  ...
  static getBarycoord(e, t, i, r, s) {
    en.subVectors(r, t), xn.subVectors(i, t), jr.subVectors(e, t);
    const a = en.dot(en), o = en.dot(xn), l = en.dot(jr), c = xn.dot(xn), d = xn.dot(jr), u = a * c - o * o;
    if (u === 0)
  ...
  static isFrontFacing(e, t, i, r) {
    return en.subVectors(i, t), xn.subVectors(e, t), en.cross(xn).dot(r) < 0;
  }
  /**
   ...
   */
  getArea() {
    return en.subVectors(this.c, this.b), xn.subVectors(this.a, this.b), en.cross(xn).length() * 0.5;
  }
  /**
  ...
  getInterpolation(e, t, i, r, s) {
    return nn.getInterpolation(e, this.a, this.b, this.c, t, i, r, s);
  }
  /**
   * Returns `true` if the given point, when projected onto the plane of the
   * triangle, lies within the triangle.
  ...
  closestPointToPoint(e, t) {
    ...
    let a, o;
    ai.subVectors(r, i), oi.subVectors(s, i), Jr.subVectors(e, i);
    const l = ai.dot(Jr), c = oi.dot(Jr);
    if (l <= 0 && c <= 0)
      return t.copy(i);
    Qr.subVectors(e, r);
    const d = ai.dot(Qr), u = oi.dot(Qr);
    if (d >= 0 && u <= d)
      return t.copy(r);
    const f = l * u - d * c;
    if (f <= 0 && l >= 0 && d <= 0)
      return a = l / (l - d), t.copy(i).addScaledVector(ai, a);
    es.subVectors(e, s);
    const p = ai.dot(es), x = oi.dot(es);
    if (x >= 0 && p <= x)
      return t.copy(s);
    const v = p * c - l * x;
    if (v <= 0 && c >= 0 && x <= 0)
      return o = c / (c - x), t.copy(i).addScaledVector(oi, o);
    const m = d * x - p * u;
    if (m <= 0 && u - d >= 0 && p - x >= 0)
      return pa.subVectors(s, r), o = (u - d) / (u - d + (p - x)), t.copy(r).addScaledVector(pa, o);
    const h = 1 / (m + v + f);
    return a = v * h, o = f * h, t.copy(i).addScaledVector(ai, a).addScaledVector(oi, o);
  }
  /**
...
class Qe {
  ...
  setHSL(e, t, i, r = Ze.workingColorSpace) {
    if (e = Jo(e, 1), t = Ye(t, 0, 1), i = Ye(i, 0, 1), t === 0)
   ...
   */
  lerpHSL(e, t) {
    this.getHSL(Rn), e.getHSL(ir);
    const i = Gr(Rn.h, ir.h, t), r = Gr(Rn.s, ir.s, t), s = Gr(Rn.l, ir.l, t);
...
const vt = /* @__PURE__ */ new G(), rr = /* @__PURE__ */ new rt();
let pl = 0;
class dn {
  /**
  ...
  constructor(e, t, i = !1) {
    ...
    this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: pl++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = i, this.usage = 35044, this.updateRanges = [], this.gpuType = 1015, this.version = 0;
  }
  /**
  ...
  applyMatrix3(e) {
    if (this.itemSize === 2)
      for (let t = 0, i = this.count; t < i; t++)
        rr.fromBufferAttribute(this, t), rr.applyMatrix3(e), this.setXY(t, rr.x, rr.y);
  ...
  getComponent(e, t) {
    ...
    return this.normalized && (i = Ti(i, this.array)), i;
  }
  /**
...
let ml = 0;
const $t = /* @__PURE__ */ new bt(), ss = /* @__PURE__ */ new qt(), li = /* @__PURE__ */ new G(), kt = /* @__PURE__ */ new Xi(), Ri = /* @__PURE__ */ new Xi(), Tt = /* @__PURE__ */ new G();
class Ln extends bi {
  /**
   ...
   */
  setIndex(e) {
    return Array.isArray(e) ? this.index = new (eo(e) ? so : ro)(e, 1) : this.index = e, this;
  }
  /**
    ...
    if (e) {
      ...
      if (kt.setFromBufferAttribute(e), t)
        for (let s = 0, a = t.length; s < a; s++) {
          const o = t[s];
          Ri.setFromBufferAttribute(o), this.morphTargetsRelative ? (Tt.addVectors(kt.min, Ri.min), kt.expandByPoint(Tt), Tt.addVectors(kt.max, Ri.max), kt.expandByPoint(Tt)) : (kt.expandByPoint(Ri.min), kt.expandByPoint(Ri.max));
        }
      kt.getCenter(i);
      let r = 0;
      ...
      if (t)
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          for (let c = 0, d = o.count; c < d; c++)
            Tt.fromBufferAttribute(o, c), l && (li.fromBufferAttribute(e, c), Tt.add(li)), r = Math.max(r, i.distanceToSquared(Tt));
        }
  ...
  computeTangents() {
    ...
    const y = new G(), A = new G(), D = new G(), E = new G();
    function P(O) {
      D.fromBufferAttribute(r, O), E.copy(D);
      const M = o[O];
      y.copy(M), y.sub(D.multiplyScalar(D.dot(M))).normalize(), A.crossVectors(E, M);
      const L = A.dot(l[O]) < 0 ? -1 : 1;
      a.setXYZW(O, y.x, y.y, y.z, L);
    }
    for (let O = 0, M = T.length; O < M; ++O) {
      const S = T[O], L = S.start, z = S.count;
      for (let H = L, q = L + z; H < q; H += 3)
...
const ma = /* @__PURE__ */ new bt(), On = /* @__PURE__ */ new al(), sr = /* @__PURE__ */ new Ds(), xa = /* @__PURE__ */ new G(), ar = /* @__PURE__ */ new G(), or = /* @__PURE__ */ new G(), lr = /* @__PURE__ */ new G(), as = /* @__PURE__ */ new G(), cr = /* @__PURE__ */ new G(), ga = /* @__PURE__ */ new G(), dr = /* @__PURE__ */ new G();
class Xt extends qt {
  /**
  ...
  getVertexPosition(e, t) {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const d = o[l], u = s[l];
        d !== 0 && (as.fromBufferAttribute(u, e), a ? cr.addScaledVector(as, d) : cr.addScaledVector(as.sub(t), d));
      }
      t.add(cr);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 && (i.boundingSphere === null && i.computeBoundingSphere(), sr.copy(i.boundingSphere), sr.applyMatrix4(s), On.copy(e.ray).recast(e.near), !(sr.containsPoint(On.origin) === !1 && (On.intersectSphere(sr, xa) === null || On.origin.distanceToSquared(xa) > (e.far - e.near) ** 2)) && (ma.copy(s).invert(), On.copy(e.ray).applyMatrix4(ma), !(i.boundingBox !== null && On.intersectsBox(i.boundingBox) === !1) && this._computeIntersections(e, t, On)));
  }
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let x = 0, v = f.length; x < v; x++) {
          const m = f[x], h = a[m.materialIndex], T = Math.max(m.start, p.start), y = Math.min(o.count, Math.min(m.start + m.count, p.start + p.count));
          for (let A = T, D = y; A < D; A += 3) {
            const E = o.getX(A), P = o.getX(A + 1), O = o.getX(A + 2);
            r = ur(this, h, e, i, c, d, u, E, P, O), r && (r.faceIndex = Math.floor(A / 3), r.face.materialIndex = m.materialIndex, t.push(r));
          }
        }
      else {
        const x = Math.max(0, p.start), v = Math.min(o.count, p.start + p.count);
        for (let m = x, h = v; m < h; m += 3) {
          const T = o.getX(m), y = o.getX(m + 1), A = o.getX(m + 2);
          r = ur(this, a, e, i, c, d, u, T, y, A), r && (r.faceIndex = Math.floor(m / 3), t.push(r));
        }
      }
    else if (l !== void 0)
      if (Array.isArray(a))
        for (let x = 0, v = f.length; x < v; x++) {
          const m = f[x], h = a[m.materialIndex], T = Math.max(m.start, p.start), y = Math.min(l.count, Math.min(m.start + m.count, p.start + p.count));
          for (let A = T, D = y; A < D; A += 3) {
            const E = A, P = A + 1, O = A + 2;
            r = ur(this, h, e, i, c, d, u, E, P, O), r && (r.faceIndex = Math.floor(A / 3), r.face.materialIndex = m.materialIndex, t.push(r));
          }
        }
      else {
...
function xl(n, e, t, i, r, s, a, o) {
  ...
  dr.copy(o), dr.applyMatrix4(n.matrixWorld);
...
function ur(n, e, t, i, r, s, a, o, l, c) {
  n.getVertexPosition(o, ar), n.getVertexPosition(l, or), n.getVertexPosition(c, lr);
  const d = xl(n, e, t, i, ar, or, lr, ga);
  if (d) {
    const u = new G();
    nn.getBarycoord(ga, ar, or, lr, u), r && (d.uv = nn.getInterpolatedAttribute(r, o, l, c, u, new rt())), s && (d.uv1 = nn.getInterpolatedAttribute(s, o, l, c, u, new rt())), a && (d.normal = nn.getInterpolatedAttribute(a, o, l, c, u, new G()), d.normal.dot(i.direction) > 0 && d.normal.multiplyScalar(-1));
    const f = {
      a: o,
      b: l,
      c,
    ...
    nn.getNormal(ar, or, lr, f.normal), d.face = f, d.barycoord = u;
  }
  return d;
}
class qi extends Ln {
  ...
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, a = 1) {
    ...
    function x(v, m, h, T, y, A, D, E, P, O, M) {
      const S = A / P, L = D / O, z = A / 2, H = D / 2, q = E / 2, K = P + 1, Y = O + 1;
      let te = 0, W = 0;
      const Q = new G();
      for (let re = 0; re < Y; re++) {
        ...
        for (let ke = 0; ke < K; ke++) {
          const et = ke * S - z;
          Q[v] = et * T, Q[m] = Me * y, Q[h] = q, c.push(Q.x, Q.y, Q.z), Q[v] = 0, Q[m] = 0, Q[h] = E > 0 ? 1 : -1, d.push(Q.x, Q.y, Q.z), u.push(ke / P), u.push(1 - re / O), te += 1;
        }
      }
...
class yn extends Lr {
   ...
   */
  constructor(e) {
    super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = vl, this.fragmentShader = Sl, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
      clipCullDistance: !1,
...
const Pn = /* @__PURE__ */ new G(), _a = /* @__PURE__ */ new rt(), va = /* @__PURE__ */ new rt();
class Zt extends oo {
  /**
...
class Ml extends qt {
  ...
  constructor(e, t, i) {
    ...
    const r = new Zt(ci, di, e, t);
    r.layers = this.layers, this.add(r);
    const s = new Zt(ci, di, e, t);
    s.layers = this.layers, this.add(s);
    const a = new Zt(ci, di, e, t);
    a.layers = this.layers, this.add(a);
    const o = new Zt(ci, di, e, t);
    o.layers = this.layers, this.add(o);
    const l = new Zt(ci, di, e, t);
    l.layers = this.layers, this.add(l);
    const c = new Zt(ci, di, e, t);
...
class os {
   ...
   */
  getTargetRaySpace() {
    return this._targetRay === null && (this._targetRay = new Di(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new G(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new G()), this._targetRay;
  }
  /**
   ...
   */
  getGripSpace() {
    return this._grip === null && (this._grip = new Di(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new G(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new G()), this._grip;
  }
  /**
  ...
  update(e, t, i) {
    ...
    if (e && t.session.visibilityState !== "visible-blurred") {
      ...
      o !== null && (r = t.getPose(e.targetRaySpace, i), r === null && s !== null && (r = s), r !== null && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = !0, r.linearVelocity ? (o.hasLinearVelocity = !0, o.linearVelocity.copy(r.linearVelocity)) : o.hasLinearVelocity = !1, r.angularVelocity ? (o.hasAngularVelocity = !0, o.angularVelocity.copy(r.angularVelocity)) : o.hasAngularVelocity = !1, this.dispatchEvent(El)));
    }
...
const ls = /* @__PURE__ */ new G(), Al = /* @__PURE__ */ new G(), wl = /* @__PURE__ */ new Be();
class Vn {
  /**
  ...
  setFromCoplanarPoints(e, t, i) {
    const r = ls.subVectors(i, t).cross(Al.subVectors(e, t)).normalize();
   ...
   */
  applyMatrix4(e, t) {
    const i = t || wl.getNormalMatrix(e), r = this.coplanarPoint(ls).applyMatrix4(e), s = this.normal.applyMatrix3(i).normalize();
...
const Bn = /* @__PURE__ */ new Ds(), Cl = /* @__PURE__ */ new rt(0.5, 0.5), fr = /* @__PURE__ */ new G();
class co {
  /**
  ...
  setFromProjectionMatrix(e, t = 2e3, i = !1) {
    const r = this.planes, s = e.elements, a = s[0], o = s[1], l = s[2], c = s[3], d = s[4], u = s[5], f = s[6], p = s[7], x = s[8], v = s[9], m = s[10], h = s[11], T = s[12], y = s[13], A = s[14], D = s[15];
    if (r[0].setComponents(c - a, p - d, h - x, D - T).normalize(), r[1].setComponents(c + a, p + d, h + x, D + T).normalize(), r[2].setComponents(c + o, p + u, h + v, D + y).normalize(), r[3].setComponents(c - o, p - u, h - v, D - y).normalize(), i)
  ...
  intersectsBox(e) {
    ...
    for (let i = 0; i < 6; i++) {
      const r = t[i];
      if (fr.x = r.normal.x > 0 ? e.max.x : e.min.x, fr.y = r.normal.y > 0 ? e.max.y : e.min.y, fr.z = r.normal.z > 0 ? e.max.z : e.min.z, r.distanceToPoint(fr) < 0)
        return !1;
    }
    return !0;
  }
...
class fo extends Pt {
  ...
  copy(e) {
    return super.copy(e), this.source = new Ps(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
  }
  toJSON(e) {
    const t = super.toJSON(e);
...
class tn extends Ln {
  ...
  constructor(e = 1, t = 1, i = 1, r = 1) {
    ...
    for (let h = 0; h < d; h++) {
      ...
      for (let y = 0; y < c; y++) {
        const A = y * u - s;
        x.push(A, -T, 0), v.push(0, 0, 1), m.push(y / o), m.push(1 - h / l);
      }
    }
    for (let h = 0; h < l; h++)
      for (let T = 0; T < o; T++) {
        const y = T + c * h, A = T + c * (h + 1), D = T + 1 + c * (h + 1), E = T + 1 + c * h;
        p.push(y, A, E), p.push(A, D, E);
      }
...
class Ls {
   ...
   */
  constructor(e) {
    this.manager = e !== void 0 ? e : Ll, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {};
  }
  /**
  ...
  load(e, t, i, r) {
    ...
    if (a !== void 0) {
      if (a.complete === !0)
        ...
        let u = ui.get(a);
        u === void 0 && (u = [], ui.set(a, u)), u.push({ onLoad: t, onError: r });
      }
      return a;
    }
    const o = Gi("img");
    function l() {
      ...
      ui.delete(this), s.manager.itemEnd(e);
    }
    function c(u) {
      ...
      ui.delete(this), s.manager.itemError(e), s.manager.itemEnd(e);
    }
    function d() {
...
class Fl extends Ls {
   ...
   */
  load(e, t, i, r) {
    const s = new Pt(), a = new Ul(this.manager);
...
#endif`, mc = "gl_FragColor = linearToOutputTexel( gl_FragColor );", xc = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
const hr = { r: 0, b: 0, g: 0 }, zn = /* @__PURE__ */ new En(), _u = /* @__PURE__ */ new bt();
function vu(n, e, t, i, r, s, a) {
  const o = new Qe(0);
  let l = s === !0 ? 0 : 1, c, d, u = null, f = 0, p = null;
  function x(y) {
    let A = y.isScene === !0 ? y.background : null;
    return A && A.isTexture && (A = (y.backgroundBlurriness > 0 ? t : e).get(A)), A;
  }
  function v(y) {
    let A = !1;
    const D = x(y);
    ...
    E === "additive" ? i.buffers.color.setClear(0, 0, 0, 1, a) : E === "alpha-blend" && i.buffers.color.setClear(0, 0, 0, 0, a), (n.autoClear || A) && (i.buffers.depth.setTest(!0), i.buffers.depth.setMask(!0), i.buffers.color.setMask(!0), n.clear(n.autoClearColor, n.autoClearDepth, n.autoClearStencil));
  }
  function m(y, A) {
    const D = x(A);
    D && (D.isCubeTexture || D.mapping === 306) ? (d === void 0 && (d = new Xt(
      ...
      new yn({
        ...
        uniforms: vi(ln.backgroundCube.uniforms),
    ...
    ), d.geometry.deleteAttribute("normal"), d.geometry.deleteAttribute("uv"), d.onBeforeRender = function(E, P, O) {
      this.matrixWorld.copyPosition(O.matrixWorld);
    }, Object.defineProperty(d.material, "envMap", {
      get: function() {
        return this.uniforms.envMap.value;
      }
    }), r.update(d)), zn.copy(A.backgroundRotation), zn.x *= -1, zn.y *= -1, zn.z *= -1, D.isCubeTexture && D.isRenderTargetTexture === !1 && (zn.y *= -1, zn.z *= -1), d.material.uniforms.envMap.value = D, d.material.uniforms.flipEnvMap.value = D.isCubeTexture && D.isRenderTargetTexture === !1 ? -1 : 1, d.material.uniforms.backgroundBlurriness.value = A.backgroundBlurriness, d.material.uniforms.backgroundIntensity.value = A.backgroundIntensity, d.material.uniforms.backgroundRotation.value.setFromMatrix4(_u.makeRotationFromEuler(zn)), d.material.toneMapped = Ze.getTransfer(D.colorSpace) !== it, (u !== D || f !== D.version || p !== n.toneMapping) && (d.material.needsUpdate = !0, u = D, f = D.version, p = n.toneMapping), d.layers.enableAll(), y.unshift(d, d.geometry, d.material, 0, 0, null)) : D && D.isTexture && (c === void 0 && (c = new Xt(
      new tn(2, 2),
      new yn({
        name: "BackgroundMaterial",
        uniforms: vi(ln.background.uniforms),
  ...
  function h(y, A) {
    y.getRGB(hr, ao(n)), i.buffers.color.setClear(hr.r, hr.g, hr.b, A, a);
  }
  function T() {
  ...
  function d(u, f, p, x) {
    ...
    if (v !== 0) {
      if (m = l.value, x !== !0 || m === null) {
        ...
        for (let y = 0, A = p; y !== v; ++y, A += 4)
          a.copy(u[y]).applyMatrix4(T, o), a.normal.toArray(m, A), m[A + 3] = a.constant;
      }
...
const Dn = 4, Ma = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], qn = 20, Tu = 256, Pi = /* @__PURE__ */ new Il(), ba = /* @__PURE__ */ new Qe();
let ds = null, us = 0, fs = 0, hs = !1;
const Au = /* @__PURE__ */ new G();
class Ea {
  /**
  ...
  _cleanup(e) {
    this._renderer.setRenderTarget(ds, us, fs), this._renderer.xr.enabled = hs, e.scissorTest = !1, fi(e, 0, 0, e.width, e.height);
  }
  _fromTexture(e, t) {
  ...
  _allocateTargets() {
    ...
    if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
      ...
      ({ lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas } = wu(s)), this._blurMaterial = Ru(s, e, t), this._ggxMaterial = Cu(s, e, t);
    }
    return r;
  }
  _compileMaterial(e) {
  ...
  _sceneToCubeUV(e, t, i, r, s) {
    ...
    u.getClearColor(ba), u.toneMapping = 0, u.autoClear = !1, u.state.buffers.depth.getReversed() && (u.setRenderTarget(r), u.clearDepth(), u.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Xt(
      new qi(),
      new Yn({
    ...
    T ? T.isColor && (m.color.copy(T), e.background = null, h = !0) : (m.color.copy(ba), h = !0);
    for (let y = 0; y < 6; y++) {
      const A = y % 3;
      A === 0 ? (l.up.set(0, c[y], 0), l.position.set(s.x, s.y, s.z), l.lookAt(s.x + d[y], s.y, s.z)) : A === 1 ? (l.up.set(0, 0, c[y]), l.position.set(s.x, s.y, s.z), l.lookAt(s.x, s.y + d[y], s.z)) : (l.up.set(0, c[y], 0), l.position.set(s.x, s.y, s.z), l.lookAt(s.x, s.y, s.z + d[y]));
      const D = this._cubeSize;
      fi(r, A * D, y > 2 ? D : 0, D, D), u.setRenderTarget(r), h && u.render(v, l), u.render(e, l);
    }
    u.toneMapping = p, u.autoClear = f, e.background = T;
  }
  _textureToCubeUV(e, t) {
    const i = this._renderer, r = e.mapping === 301 || e.mapping === 302;
    r ? (this._cubemapMaterial === null && (this._cubemapMaterial = Aa()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Ta());
    const s = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
    a.material = s;
    const o = s.uniforms;
    o.envMap.value = e;
    const l = this._cubeSize;
    fi(t, 0, 0, 3 * l, 2 * l), i.setRenderTarget(t), i.render(a, Pi);
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, i) {
    ...
    l.envMap.value = e.texture, l.roughness.value = p, l.mipInt.value = x - t, fi(s, m, h, 3 * v, 2 * v), r.setRenderTarget(s), r.render(o, Pi), l.envMap.value = s.texture, l.roughness.value = 0, l.mipInt.value = x - i, fi(e, m, h, 3 * v, 2 * v), r.setRenderTarget(e), r.render(o, Pi);
  }
  /**
  ...
  _halfBlur(e, t, i, r, s, a, o) {
    ...
    f.dTheta.value = x, f.mipInt.value = y - i;
    const A = this._sizeLods[r], D = 3 * A * (r > y - Dn ? r - y + Dn : 0), E = 4 * (this._cubeSize - A);
    fi(t, D, E, 3 * A, 2 * A), l.setRenderTarget(t), l.render(u, Pi);
  }
}
function wu(n) {
  const e = [], t = [], i = [];
  let r = n;
  const s = n - Dn + 1 + Ma.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    a > n - Dn ? l = Ma[a - n + Dn - 1] : a === 0 && (l = 0), t.push(l);
    const c = 1 / (o - 2), d = -c, u = 1 + c, f = [d, d, u, d, u, u, d, d, u, u, d, u], p = 6, x = 6, v = 3, m = 2, h = 1, T = new Float32Array(v * x * p), y = new Float32Array(m * x * p), A = new Float32Array(h * x * p);
    for (let E = 0; E < p; E++) {
      const P = E % 3 * 2 / 3 - 1, O = E > 2 ? 0 : -1, M = [
        P,
        O,
        0,
        P + 2 / 3,
      ...
      T.set(M, v * x * E), y.set(f, m * x * E);
      const S = [E, E, E, E, E, E];
      A.set(S, h * x * E);
    }
    const D = new Ln();
    D.setAttribute("position", new dn(T, v)), D.setAttribute("uv", new dn(y, m)), D.setAttribute("faceIndex", new dn(A, h)), i.push(new Xt(D, null)), r > Dn && r--;
  }
  return { lodMeshes: i, sizeLods: e, sigmas: t };
}
function ya(n, e, t) {
  const i = new Zn(n, e, t);
    ...
    if (o && o.isTexture) {
      ...
      if (c || d) {
        ...
        if (o.isRenderTargetTexture && o.pmremVersion !== f)
          return t === null && (t = new Ea(n)), u = c ? t.fromEquirectangular(o, u) : t.fromCubemap(o, u), u.texture.pmremVersion = o.pmremVersion, e.set(o, u), u.texture;
        if (u !== void 0)
          return u.texture;
        {
          const p = o.image;
          return c && p && p.height > 0 || d && p && r(p) ? (t === null && (t = new Ea(n)), u = c ? t.fromEquirectangular(o) : t.fromCubemap(o), u.texture.pmremVersion = o.pmremVersion, e.set(o, u), o.addEventListener("dispose", s), u.texture) : null;
        }
      }
    }
    return o;
...
function Du(n) {
  ...
  return {
    ...
    get: function(i) {
      const r = t(i);
      return r === null && Vi("WebGLRenderer: " + i + " extension not supported."), r;
    }
  };
}
function Lu(n, e, t, i) {
  ...
  function c(u) {
    ...
    if (p !== null) {
      ...
      for (let y = 0, A = T.length / 3 - 1; y < A; y += 3) {
        const D = y + 0, E = y + 1, P = y + 2;
        f.push(D, E, E, P, P, D);
      }
    } else
      return;
    const m = new (eo(f) ? so : ro)(f, 1);
    m.version = v;
    const h = s.get(u);
...
function Iu(n, e, t) {
  ...
  function s(a, o, l) {
    ...
    if (f === void 0 || f.count !== u) {
      ...
      let y = 0;
      p === !0 && (y = 1), x === !0 && (y = 2), v === !0 && (y = 3);
      let A = o.attributes.position.count * y, D = 1;
      A > e.maxTextureSize && (D = Math.ceil(A / e.maxTextureSize), A = e.maxTextureSize);
      const E = new Float32Array(A * D * 4 * u), P = new to(E, A, D, u);
      ...
      for (let S = 0; S < u; S++) {
        ...
        for (let K = 0; K < L.count; K++) {
          const Y = K * O;
          p === !0 && (r.fromBufferAttribute(L, K), E[q + Y + 0] = r.x, E[q + Y + 1] = r.y, E[q + Y + 2] = r.z, E[q + Y + 3] = 0), x === !0 && (r.fromBufferAttribute(z, K), E[q + Y + 4] = r.x, E[q + Y + 5] = r.y, E[q + Y + 6] = r.z, E[q + Y + 7] = 0), v === !0 && (r.fromBufferAttribute(H, K), E[q + Y + 8] = r.x, E[q + Y + 9] = r.y, E[q + Y + 10] = r.z, E[q + Y + 11] = H.itemSize === 4 ? r.w : 1);
        }
      }
      f = {
        count: u,
...
const mo = /* @__PURE__ */ new Pt(), wa = /* @__PURE__ */ new fo(1, 1), xo = /* @__PURE__ */ new to(), go = /* @__PURE__ */ new rl(), _o = /* @__PURE__ */ new lo(), Ca = [], Ra = [], Pa = new Float32Array(16), Da = new Float32Array(9), La = new Float32Array(4);
function Ei(n, e, t) {
  const i = n[0];
  if (i <= 0 || i > 0) return n;
  const r = e * t;
...
function Vu(n, e) {
  ...
  if (i === void 0) {
    ...
    if (Et(t, i)) return;
    La.set(i), n.uniformMatrix2fv(this.addr, !1, La), yt(t, i);
  }
}
function ku(n, e) {
  const t = this.cache, i = e.elements;
  if (i === void 0) {
    ...
    if (Et(t, i)) return;
    Da.set(i), n.uniformMatrix3fv(this.addr, !1, Da), yt(t, i);
  }
}
function Hu(n, e) {
  const t = this.cache, i = e.elements;
  if (i === void 0) {
    ...
    if (Et(t, i)) return;
    Pa.set(i), n.uniformMatrix4fv(this.addr, !1, Pa), yt(t, i);
  }
}
function Wu(n, e) {
  const t = this.cache;
...
function Ju(n, e, t) {
  ...
  let s;
  this.type === n.SAMPLER_2D_SHADOW ? (wa.compareFunction = 515, s = wa) : s = mo, t.setTexture2D(e || s, r);
}
function Qu(n, e, t) {
  const i = this.cache, r = t.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), i[0] = r), t.setTexture3D(e || go, r);
}
function ef(n, e, t) {
  const i = this.cache, r = t.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), i[0] = r), t.setTextureCube(e || _o, r);
}
function tf(n, e, t) {
  const i = this.cache, r = t.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), i[0] = r), t.setTexture2DArray(e || xo, r);
}
function nf(n) {
  switch (n) {
    case 5126:
...
function vf(n, e, t) {
  const i = this.cache, r = e.length, s = Fr(t, r);
...
function bf(n, e, t) {
  ...
  Et(i, s) || (n.uniform1iv(this.addr, s), yt(i, s));
  for (let a = 0; a !== r; ++a)
    t.setTexture2DArray(e[a] || xo, s[a]);
}
function Ef(n) {
  switch (n) {
    case 5126:
...
class yf {
  constructor(e, t, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = t.type, this.setValue = nf(t.type);
  }
}
class Tf {
  constructor(e, t, i) {
...
function wf(n, e, t) {
  ...
  for (ps.lastIndex = 0; ; ) {
    ...
    if (l && (o = o | 0), c === void 0 || c === "[" && a + 2 === r) {
      Ua(t, c === void 0 ? new yf(o, n, e) : new Tf(o, n, e));
      break;
    } else {
      let u = t.map[o];
      u === void 0 && (u = new Af(o), Ua(t, u)), t = u;
    }
  }
}
class mr {
...
const Ia = /* @__PURE__ */ new Be();
function Df(n) {
  Ze._getMatrix(Ia, Ze.workingColorSpace, n);
...
const pr = /* @__PURE__ */ new G();
function Ff() {
  Ze.getLuminanceCoefficients(pr);
  const n = pr.x.toFixed(4), e = pr.y.toFixed(4), t = pr.z.toFixed(4);
  return [
...
function $f(n, e, t, i) {
  ...
  const l = Hf(t), c = Wf(t), d = Xf(t), u = qf(t), f = Yf(t), p = If(t), x = Nf(s), v = r.createProgram();
...
`)), a = _s(a), a = Oa(a, t), a = Ba(a, t), o = _s(o), o = Oa(o, t), o = Ba(o, t), a = za(a), o = za(o), t.isRawShaderMaterial !== !0 && (T = `#version 300 es
`, m = [
    p,
    "#define attribute in",
    "#define varying out",
...
`) + `
` + h);
  const y = T + m + a, A = T + h + o, D = Fa(r, r.VERTEX_SHADER, y), E = Fa(r, r.FRAGMENT_SHADER, A);
  r.attachShader(v, D), r.attachShader(v, E), t.index0AttributeName !== void 0 ? r.bindAttribLocation(v, 0, t.index0AttributeName) : t.morphTargets === !0 && r.bindAttribLocation(v, 0, "position"), r.linkProgram(v);
  function P(L) {
    if (n.debug.checkShaderErrors) {
      const z = r.getProgramInfoLog(v) || "", H = r.getShaderInfoLog(D) || "", q = r.getShaderInfoLog(E) || "", K = z.trim(), Y = H.trim(), te = q.trim();
      let W = !0, Q = !0;
      if (r.getProgramParameter(v, r.LINK_STATUS) === !1)
        if (W = !1, typeof n.debug.onShaderError == "function")
          n.debug.onShaderError(r, v, D, E);
        else {
          const re = Na(r, D, "vertex"), Me = Na(r, E, "fragment");
          gt(
...
` + Me
    ...
    r.deleteShader(D), r.deleteShader(E), O = new mr(r, v), M = Of(r, v);
  }
  let O;
  ...
  return this.isReady = function() {
    return S === !1 && (S = r.getProgramParameter(v, Cf)), S;
  }, this.destroy = function() {
    i.releaseStatesOfProgram(this), r.deleteProgram(v), this.program = void 0;
  }, this.type = t.shaderType, this.name = t.shaderName, this.id = Rf++, this.cacheKey = e, this.usedTimes = 1, this.program = v, this.vertexShader = D, this.fragmentShader = E, this;
}
let Kf = 0;
class Zf {
  constructor() {
  ...
  _getShaderStage(e) {
    ...
    let i = t.get(e);
    return i === void 0 && (i = new jf(e), t.set(e, i)), i;
  }
}
class jf {
  constructor(e) {
...
function Jf(n, e, t, i, r, s, a) {
  const o = new no(), l = new Zf(), c = /* @__PURE__ */ new Set(), d = [], u = r.logarithmicDepthBuffer, f = r.vertexTextures;
  let p = r.precision;
  const x = {
  ...
  function m(M, S, L, z, H) {
    ...
    const X = n.getRenderTarget(), ne = n.state.buffers.depth.getReversed(), Se = H.isInstancedMesh === !0, ue = H.isBatchedMesh === !0, Ne = !!M.map, xt = !!M.matcap, Ve = !!te, at = !!M.aoMap, w = !!M.lightMap, He = !!M.bumpMap, We = !!M.normalMap, lt = !!M.displacementMap, _e = !!M.emissiveMap, ut = !!M.metalnessMap, Te = !!M.roughnessMap, Ie = M.anisotropy > 0, b = M.clearcoat > 0, g = M.dispersion > 0, I = M.iridescence > 0, $ = M.sheen > 0, j = M.transmission > 0, k = Ie && !!M.anisotropyMap, be = b && !!M.clearcoatMap, ce = b && !!M.clearcoatNormalMap, Ae = b && !!M.clearcoatRoughnessMap, ve = I && !!M.iridescenceMap, J = I && !!M.iridescenceThicknessMap, se = $ && !!M.sheenColorMap, Pe = $ && !!M.sheenRoughnessMap, Ce = !!M.specularMap, he = !!M.specularColorMap, Ue = !!M.specularIntensityMap, C = j && !!M.transmissionMap, de = j && !!M.thicknessMap, ae = !!M.gradientMap, oe = !!M.alphaMap, ee = M.alphaTest > 0, Z = !!M.alphaHash, xe = !!M.extensions;
    let Fe = 0;
    M.toneMapped && (X === null || X.isXRRenderTarget === !0) && (Fe = n.toneMapping);
    const ct = {
      shaderID: Q,
      shaderType: M.type,
      shaderName: M.name,
      ...
      outputColorSpace: X === null ? n.outputColorSpace : X.isXRRenderTarget === !0 ? X.texture.colorSpace : _i,
      ...
      //
      vertexTangents: !!K.attributes.tangent && (We || Ie),
  ...
  function h(M) {
    ...
    return M.isRawShaderMaterial === !1 && (T(S, M), y(S, M), S.push(n.outputColorSpace)), S.push(M.customProgramCacheKey), S.join();
  }
  function T(M, S) {
  ...
  function D(M, S) {
    ...
    return L === void 0 && (L = new $f(n, S, M, s), d.push(L)), L;
  }
  function E(M) {
    if (--M.usedTimes === 0) {
      const S = d.indexOf(M);
...
function ka() {
  ...
  function c(u, f) {
    t.length > 1 && t.sort(u || eh), i.length > 1 && i.sort(f || Va), r.length > 1 && r.sort(f || Va);
  }
  function d() {
...
function th() {
  ...
  function e(i, r) {
    const s = n.get(i);
    let a;
    return s === void 0 ? (a = new ka(), n.set(i, [a])) : r >= s.length ? (a = new ka(), s.push(a)) : a = s[r], a;
  }
  function t() {
    n = /* @__PURE__ */ new WeakMap();
  }
...
function ah(n) {
  ...
  function o(c) {
    ...
    let p = 0, x = 0, v = 0, m = 0, h = 0, T = 0, y = 0, A = 0, D = 0, E = 0, P = 0;
    c.sort(sh);
    for (let M = 0, S = c.length; M < S; M++) {
      ...
      if (L.isAmbientLight)
        ...
        const te = L.shadow;
        if (L.map && (i.spotLightMap[D] = L.map, D++, te.updateMatrices(L), L.castShadow && E++), i.spotLightMatrix[v] = te.matrix, L.castShadow) {
          const W = t.get(L);
        ...
        if (Y.color.copy(L.color).multiplyScalar(L.intensity), Y.distance = L.distance, Y.decay = L.decay, L.castShadow) {
          const te = L.shadow, W = t.get(L);
          W.shadowIntensity = te.intensity, W.shadowBias = te.bias, W.shadowNormalBias = te.normalBias, W.shadowRadius = te.radius, W.shadowMapSize = te.mapSize, W.shadowCameraNear = te.camera.near, W.shadowCameraFar = te.camera.far, i.pointShadow[x] = W, i.pointShadowMap[x] = K, i.pointShadowMatrix[x] = L.shadow.matrix, y++;
        }
        i.point[x] = Y, x++;
  ...
  function l(c, d) {
    ...
    for (let h = 0, T = c.length; h < T; h++) {
      ...
      if (y.isDirectionalLight) {
        ...
        A.direction.setFromMatrixPosition(y.matrixWorld), r.setFromMatrixPosition(y.target.matrixWorld), A.direction.sub(r), A.direction.transformDirection(m), u++;
      } else if (y.isSpotLight) {
        const A = i.spot[p];
        A.position.setFromMatrixPosition(y.matrixWorld), A.position.applyMatrix4(m), A.direction.setFromMatrixPosition(y.matrixWorld), r.setFromMatrixPosition(y.target.matrixWorld), A.direction.sub(r), A.direction.transformDirection(m), p++;
      } else if (y.isRectAreaLight) {
        const A = i.rectArea[x];
        A.position.setFromMatrixPosition(y.matrixWorld), A.position.applyMatrix4(m), a.identity(), s.copy(y.matrixWorld), s.premultiply(m), a.extractRotation(s), A.halfWidth.set(y.width * 0.5, 0, 0), A.halfHeight.set(0, y.height * 0.5, 0), A.halfWidth.applyMatrix4(a), A.halfHeight.applyMatrix4(a), x++;
      } else if (y.isPointLight) {
        const A = i.point[f];
        A.position.setFromMatrixPosition(y.matrixWorld), A.position.applyMatrix4(m), f++;
      } else if (y.isHemisphereLight) {
        const A = i.hemi[v];
        A.direction.setFromMatrixPosition(y.matrixWorld), A.direction.transformDirection(m), v++;
      }
    }
  }
  return {
...
function oh(n) {
  ...
  function t(r, s = 0) {
    const a = e.get(r);
    let o;
    return a === void 0 ? (o = new Ha(n), e.set(r, [o])) : s >= a.length ? (o = new Ha(n), a.push(o)) : o = a[s], o;
  }
  function i() {
    e = /* @__PURE__ */ new WeakMap();
  }
...
function dh(n, e, t) {
  let i = new co();
  const r = new rt(), s = new rt(), a = new _t(), o = new Rl({ depthPacking: 3201 }), l = new Pl(), c = {}, d = t.maxTextureSize, u = { 0: 1, 1: 0, 2: 2 }, f = new yn({
    defines: {
      VSM_SAMPLES: 8
    },
    uniforms: {
  ...
  this.render = function(E, P, O) {
    ...
    for (let K = 0, Y = E.length; K < Y; K++) {
      const te = E[K], W = te.shadow;
      if (W === void 0) {
      ...
      if (r.multiply(Q), s.copy(W.mapSize), (r.x > d || r.y > d) && (r.x > d && (s.x = Math.floor(d / Q.x), r.x = s.x * Q.x, W.mapSize.x = s.x), r.y > d && (s.y = Math.floor(d / Q.y), r.y = s.y * Q.y, W.mapSize.y = s.y)), W.map === null || H === !0 || q === !0) {
        ...
        W.map !== null && W.map.dispose(), W.map = new Zn(r.x, r.y, Me), W.map.texture.name = te.name + ".shadowMap", W.camera.updateProjectionMatrix();
      }
  ...
  function y(E, P, O, M) {
    let S = null;
    const L = O.isPointLight === !0 ? E.customDistanceMaterial : E.customDepthMaterial;
    if (L !== void 0)
      S = L;
  ...
  function A(E, P, O, M, S) {
    if (E.visible === !1) return;
    if (E.layers.test(P.layers) && (E.isMesh || E.isLine || E.isPoints) && (E.castShadow || E.receiveShadow && S === 3) && (!E.frustumCulled || i.intersectsObject(E))) {
      E.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, E.matrixWorld);
      const H = e.update(E), q = E.material;
      if (Array.isArray(q)) {
        const K = H.groups;
        for (let Y = 0, te = K.length; Y < te; Y++) {
          ...
          if (Q && Q.visible) {
            const re = y(E, Q, M, S);
            E.onBeforeShadow(n, E, P, O, H, re, W), n.renderBufferDirect(O, null, H, re, E, W), E.onAfterShadow(n, E, P, O, H, re, W);
          }
        }
      } else if (q.visible) {
        const K = y(E, q, M, S);
        E.onBeforeShadow(n, E, P, O, H, K, null), n.renderBufferDirect(O, null, H, K, E, null), E.onAfterShadow(n, E, P, O, H, K, null);
      }
    }
    const z = E.children;
...
function fh(n, e) {
  function t() {
    ...
    return {
      ...
      setClear: function(ee, Z, xe, Fe, ct) {
        ct === !0 && (ee *= Fe, Z *= Fe, xe *= Fe), de.set(ee, Z, xe, Fe), oe.equals(de) === !1 && (n.clearColor(ee, Z, xe, Fe), oe.copy(de));
      },
      reset: function() {
  ...
  function r() {
    let C = !1, de = null, ae = null, oe = null, ee = null, Z = null, xe = null, Fe = null, ct = null;
    return {
      setTest: function(tt) {
      ...
      setFunc: function(tt, an, jt) {
        (ae !== tt || oe !== an || ee !== jt) && (n.stencilFunc(tt, an, jt), ae = tt, oe = an, ee = jt);
      },
      setOp: function(tt, an, jt) {
        (Z !== tt || xe !== an || Fe !== jt) && (n.stencilOp(tt, an, jt), Z = tt, xe = an, Fe = jt);
      },
      ...
      reset: function() {
        C = !1, de = null, ae = null, oe = null, ee = null, Z = null, xe = null, Fe = null, ct = null;
      }
    };
  }
  const s = new t(), a = new i(), o = new r(), l = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap();
  let d = {}, u = {}, f = /* @__PURE__ */ new WeakMap(), p = [], x = null, v = !1, m = null, h = null, T = null, y = null, A = null, D = null, E = null, P = new Qe(0, 0, 0), O = 0, M = !1, S = null, L = null, z = null, H = null, q = null;
  ...
  function at(C, de, ae, oe, ee, Z, xe, Fe, ct, tt) {
    if (C === 0) {
      v === !0 && (ne(n.BLEND), v = !1);
      return;
    }
    if (v === !1 && (X(n.BLEND), v = !0), C !== 5) {
      if (C !== m || tt !== M) {
        ...
        T = null, y = null, D = null, E = null, P.set(0, 0, 0), O = 0, m = C, M = tt;
      }
      return;
    }
    ee = ee || de, Z = Z || ae, xe = xe || oe, (de !== h || ee !== A) && (n.blendEquationSeparate(xt[de], xt[ee]), h = de, A = ee), (ae !== T || oe !== y || Z !== D || xe !== E) && (n.blendFuncSeparate(Ve[ae], Ve[oe], Ve[Z], Ve[xe]), T = ae, y = oe, D = Z, E = xe), (Fe.equals(P) === !1 || ct !== O) && (n.blendColor(Fe.r, Fe.g, Fe.b, ct), P.copy(Fe), O = ct), m = C, M = !1;
  }
  function w(C, de) {
  ...
  function Ue() {
    n.disable(n.BLEND), n.disable(n.CULL_FACE), n.disable(n.DEPTH_TEST), n.disable(n.POLYGON_OFFSET_FILL), n.disable(n.SCISSOR_TEST), n.disable(n.STENCIL_TEST), n.disable(n.SAMPLE_ALPHA_TO_COVERAGE), n.blendEquation(n.FUNC_ADD), n.blendFunc(n.ONE, n.ZERO), n.blendFuncSeparate(n.ONE, n.ZERO, n.ONE, n.ZERO), n.blendColor(0, 0, 0, 0), n.colorMask(!0, !0, !0, !0), n.clearColor(0, 0, 0, 0), n.depthMask(!0), n.depthFunc(n.LESS), a.setReversed(!1), n.clearDepth(1), n.stencilMask(4294967295), n.stencilFunc(n.ALWAYS, 0, 4294967295), n.stencilOp(n.KEEP, n.KEEP, n.KEEP), n.clearStencil(0), n.cullFace(n.BACK), n.frontFace(n.CCW), n.polygonOffset(0, 0), n.activeTexture(n.TEXTURE0), n.bindFramebuffer(n.FRAMEBUFFER, null), n.bindFramebuffer(n.DRAW_FRAMEBUFFER, null), n.bindFramebuffer(n.READ_FRAMEBUFFER, null), n.useProgram(null), n.lineWidth(1), n.scissor(0, 0, n.canvas.width, n.canvas.height), n.viewport(0, 0, n.canvas.width, n.canvas.height), d = {}, Q = null, re = {}, u = {}, f = /* @__PURE__ */ new WeakMap(), p = [], x = null, v = !1, m = null, h = null, T = null, y = null, A = null, D = null, E = null, P = new Qe(0, 0, 0), O = 0, M = !1, S = null, L = null, z = null, H = null, q = null, et.set(0, 0, n.canvas.width, n.canvas.height), je.set(0, 0, n.canvas.width, n.canvas.height), s.reset(), a.reset(), o.reset();
  }
  return {
    buffers: {
      color: s,
...
function hh(n, e, t, i, r, s, a) {
  ...
  function v(b, g, I) {
    let $ = 1;
    const j = Ie(b);
    if ((j.width > I || j.height > I) && ($ = I / Math.max(j.width, j.height)), $ < 1)
  ...
  function E(b) {
    const g = b.target;
    g.removeEventListener("dispose", E), O(g), g.isVideoTexture && d.delete(g);
  }
  function P(b) {
    const g = b.target;
  ...
  function O(b) {
    ...
    const I = b.source, $ = f.get(I);
    if ($) {
      const j = $[g.__cacheKey];
      j.usedTimes--, j.usedTimes === 0 && M(b), Object.keys($).length === 0 && f.delete(I);
    }
    i.remove(b);
  }
  function M(b) {
  ...
  function S(b) {
    ...
    for (let $ = 0, j = I.length; $ < j; $++) {
      const k = i.get(I[$]);
      k.__webglTexture && (n.deleteTexture(k.__webglTexture), a.memory.textures--), i.remove(I[$]);
    }
    i.remove(b);
  }
  let L = 0;
  ...
  function K(b, g) {
    const I = i.get(b);
    if (b.isVideoTexture && ut(b), b.isRenderTargetTexture === !1 && b.isExternalTexture !== !0 && b.version > 0 && I.__version !== b.version) {
      const $ = b.image;
      if ($ === null)
    ...
    t.bindTexture(n.TEXTURE_2D, I.__webglTexture, n.TEXTURE0 + g);
  }
  function Y(b, g) {
    const I = i.get(b);
    if (b.isRenderTargetTexture === !1 && b.version > 0 && I.__version !== b.version) {
      V(I, b, g);
      return;
    } else b.isExternalTexture && (I.__webglTexture = b.sourceTexture ? b.sourceTexture : null);
    t.bindTexture(n.TEXTURE_2D_ARRAY, I.__webglTexture, n.TEXTURE0 + g);
  }
  function te(b, g) {
    const I = i.get(b);
    if (b.isRenderTargetTexture === !1 && b.version > 0 && I.__version !== b.version) {
    ...
    t.bindTexture(n.TEXTURE_3D, I.__webglTexture, n.TEXTURE0 + g);
  }
  function W(b, g) {
    const I = i.get(b);
    ...
    t.bindTexture(n.TEXTURE_CUBE_MAP, I.__webglTexture, n.TEXTURE0 + g);
  }
  const Q = {
    1e3: n.REPEAT,
  ...
  function ke(b, g) {
    if (g.type === 1015 && e.has("OES_texture_float_linear") === !1 && (g.magFilter === 1006 || g.magFilter === 1007 || g.magFilter === 1005 || g.magFilter === 1008 || g.minFilter === 1006 || g.minFilter === 1007 || g.minFilter === 1005 || g.minFilter === 1008) && Oe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), n.texParameteri(b, n.TEXTURE_WRAP_S, Q[g.wrapS]), n.texParameteri(b, n.TEXTURE_WRAP_T, Q[g.wrapT]), (b === n.TEXTURE_3D || b === n.TEXTURE_2D_ARRAY) && n.texParameteri(b, n.TEXTURE_WRAP_R, Q[g.wrapR]), n.texParameteri(b, n.TEXTURE_MAG_FILTER, re[g.magFilter]), n.texParameteri(b, n.TEXTURE_MIN_FILTER, re[g.minFilter]), g.compareFunction && (n.texParameteri(b, n.TEXTURE_COMPARE_MODE, n.COMPARE_REF_TO_TEXTURE), n.texParameteri(b, n.TEXTURE_COMPARE_FUNC, Me[g.compareFunction])), e.has("EXT_texture_filter_anisotropic") === !0) {
      ...
      if (g.anisotropy > 1 || i.get(g).__currentAnisotropy) {
        ...
        n.texParameterf(b, I.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(g.anisotropy, r.getMaxAnisotropy())), i.get(g).__currentAnisotropy = g.anisotropy;
      }
    }
  }
  function et(b, g) {
    let I = !1;
    b.__webglInit === void 0 && (b.__webglInit = !0, g.addEventListener("dispose", E));
    const $ = g.source;
    let j = f.get($);
    j === void 0 && (j = {}, f.set($, j));
    const k = q(g);
    if (k !== b.__cacheKey) {
      j[k] === void 0 && (j[k] = {
        ...
        usedTimes: 0
      }, a.memory.textures++, I = !0), j[k].usedTimes++;
  ...
  function je(b, g, I) {
    return Math.floor(Math.floor(b / I) / g);
  }
  function st(b, g, I, $) {
    const k = b.updateRanges;
    if (k.length === 0)
      t.texSubImage2D(n.TEXTURE_2D, 0, 0, 0, g.width, g.height, I, $, g.data);
    else {
      ...
      for (let J = 0, se = k.length; J < se; J++) {
        ...
        n.pixelStorei(n.UNPACK_SKIP_PIXELS, Ue), n.pixelStorei(n.UNPACK_SKIP_ROWS, C), t.texSubImage2D(n.TEXTURE_2D, 0, Ue, C, de, ae, I, $, g.data);
      }
  ...
  function V(b, g, I) {
    ...
    t.bindTexture($, b.__webglTexture, n.TEXTURE0 + I);
    const be = i.get(k);
    if (k.version !== be.__version || j === !0) {
      ...
      let Ce = y(g.internalFormat, se, Pe, g.colorSpace, g.isVideoTexture);
      ke($, g);
      let he;
      ...
      if (g.isDepthTexture)
                ...
                if (C) {
                  if (ae)
                    if (g.layerUpdates.size > 0) {
                      const xe = Sa(he.width, he.height, g.format, g.type);
                      for (const Fe of g.layerUpdates) {
                        const ct = he.data.subarray(
                          Fe * xe / he.data.BYTES_PER_ELEMENT,
                          (Fe + 1) * xe / he.data.BYTES_PER_ELEMENT
                        );
                        t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY, ee, 0, 0, Fe, he.width, he.height, 1, se, ct);
                      }
                      g.clearLayerUpdates();
                    } else
        ...
        if (C) {
          if (de && t.texStorage3D(n.TEXTURE_2D_ARRAY, oe, Ce, J.width, J.height, J.depth), ae)
            if (g.layerUpdates.size > 0) {
              const ee = Sa(J.width, J.height, g.format, g.type);
  ...
  function X(b, g, I) {
    ...
    if (j.version !== k.__version || $ === !0) {
      ...
      const Pe = se[0], Ce = s.convert(g.format, g.colorSpace), he = s.convert(g.type), Ue = y(g.internalFormat, Ce, he, g.colorSpace), C = g.isVideoTexture !== !0, de = k.__version === void 0 || $ === !0, ae = j.dataReady;
      let oe = D(g, Pe);
      ...
      if (ve) {
        ...
        for (let Z = 0; Z < 6; Z++) {
          ...
          for (let xe = 0; xe < ee.length; xe++) {
            const Fe = ee[xe];
            g.format !== 1023 ? Ce !== null ? C ? ae && t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + Z, xe, 0, 0, Fe.width, Fe.height, Ce, Fe.data) : t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + Z, xe, Ue, Fe.width, Fe.height, 0, Fe.data) : Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : C ? ae && t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + Z, xe, 0, 0, Fe.width, Fe.height, Ce, he, Fe.data) : t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + Z, xe, Ue, Fe.width, Fe.height, 0, Ce, he, Fe.data);
          }
        }
      } else {
        ...
        for (let Z = 0; Z < 6; Z++)
          if (J) {
            ...
            for (let xe = 0; xe < ee.length; xe++) {
              const Fe = ee[xe];
              C ? ae && t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + Z, xe + 1, 0, 0, Ce, he, Fe.image[Z]) : t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + Z, xe + 1, Ue, Ce, he, Fe.image[Z]);
            }
          }
      }
  ...
  function ne(b, g, I, $, j, k) {
    const be = s.convert(I.format, I.colorSpace), ce = s.convert(I.type), Ae = y(I.internalFormat, be, ce, I.colorSpace), ve = i.get(g), J = i.get(I);
  ...
  function Se(b, g, I) {
    if (n.bindRenderbuffer(n.RENDERBUFFER, b), g.depthBuffer) {
      ...
      _e(g) ? o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER, ce, k, g.width, g.height) : I ? n.renderbufferStorageMultisample(n.RENDERBUFFER, ce, k, g.width, g.height) : n.renderbufferStorage(n.RENDERBUFFER, k, g.width, g.height), n.framebufferRenderbuffer(n.FRAMEBUFFER, be, n.RENDERBUFFER, b);
    } else {
      const $ = g.textures;
      for (let j = 0; j < $.length; j++) {
        const k = $[j], be = s.convert(k.format, k.colorSpace), ce = s.convert(k.type), Ae = y(k.internalFormat, be, ce, k.colorSpace), ve = lt(g);
        I && _e(g) === !1 ? n.renderbufferStorageMultisample(n.RENDERBUFFER, ve, Ae, g.width, g.height) : _e(g) ? o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER, ve, Ae, g.width, g.height) : n.renderbufferStorage(n.RENDERBUFFER, Ae, g.width, g.height);
      }
    }
  ...
  function Ne(b) {
    const g = i.get(b), I = b.isWebGLCubeRenderTarget === !0;
  ...
  function xt(b, g, I) {
    const $ = i.get(b);
    g !== void 0 && ne($.__webglFramebuffer, b, b.texture, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, 0), I !== void 0 && Ne(b);
  }
  function Ve(b) {
    const g = b.texture, I = i.get(b), $ = i.get(g);
    ...
    if (be || ($.__webglTexture === void 0 && ($.__webglTexture = n.createTexture()), $.__version = g.version, a.memory.textures++), k) {
      ...
      for (let ce = 0; ce < 6; ce++)
        if (g.mipmaps && g.mipmaps.length > 0) {
          ...
          for (let Ae = 0; Ae < g.mipmaps.length; Ae++)
            I.__webglFramebuffer[ce][Ae] = n.createFramebuffer();
        } else
          I.__webglFramebuffer[ce] = n.createFramebuffer();
    } else {
      if (g.mipmaps && g.mipmaps.length > 0) {
        I.__webglFramebuffer = [];
      ...
      if (b.samples > 0 && _e(b) === !1) {
        ...
        for (let ce = 0; ce < j.length; ce++) {
          const Ae = j[ce];
          I.__webglColorRenderbuffer[ce] = n.createRenderbuffer(), n.bindRenderbuffer(n.RENDERBUFFER, I.__webglColorRenderbuffer[ce]);
          const ve = s.convert(Ae.format, Ae.colorSpace), J = s.convert(Ae.type), se = y(Ae.internalFormat, ve, J, Ae.colorSpace, b.isXRRenderTarget === !0), Pe = lt(b);
          n.renderbufferStorageMultisample(n.RENDERBUFFER, Pe, se, b.width, b.height), n.framebufferRenderbuffer(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0 + ce, n.RENDERBUFFER, I.__webglColorRenderbuffer[ce]);
        }
        n.bindRenderbuffer(n.RENDERBUFFER, null), b.depthBuffer && (I.__webglDepthRenderbuffer = n.createRenderbuffer(), Se(I.__webglDepthRenderbuffer, b, !0)), t.bindFramebuffer(n.FRAMEBUFFER, null);
      }
    }
    if (k) {
      ...
      for (let ce = 0; ce < 6; ce++)
        if (g.mipmaps && g.mipmaps.length > 0)
          for (let Ae = 0; Ae < g.mipmaps.length; Ae++)
            ne(I.__webglFramebuffer[ce][Ae], b, g, n.COLOR_ATTACHMENT0, n.TEXTURE_CUBE_MAP_POSITIVE_X + ce, Ae);
        else
          ne(I.__webglFramebuffer[ce], b, g, n.COLOR_ATTACHMENT0, n.TEXTURE_CUBE_MAP_POSITIVE_X + ce, 0);
      m(g) && h(n.TEXTURE_CUBE_MAP), t.unbindTexture();
    } else if (be) {
      for (let ce = 0, Ae = j.length; ce < Ae; ce++) {
        const ve = j[ce], J = i.get(ve);
        let se = n.TEXTURE_2D;
        (b.isWebGL3DRenderTarget || b.isWebGLArrayRenderTarget) && (se = b.isWebGL3DRenderTarget ? n.TEXTURE_3D : n.TEXTURE_2D_ARRAY), t.bindTexture(se, J.__webglTexture), ke(se, ve), ne(I.__webglFramebuffer, b, ve, n.COLOR_ATTACHMENT0 + ce, se, 0), m(ve) && h(se);
      }
      t.unbindTexture();
    } else {
      let ce = n.TEXTURE_2D;
      if ((b.isWebGL3DRenderTarget || b.isWebGLArrayRenderTarget) && (ce = b.isWebGL3DRenderTarget ? n.TEXTURE_3D : n.TEXTURE_2D_ARRAY), t.bindTexture(ce, $.__webglTexture), ke(ce, g), g.mipmaps && g.mipmaps.length > 0)
        for (let Ae = 0; Ae < g.mipmaps.length; Ae++)
          ne(I.__webglFramebuffer[Ae], b, g, n.COLOR_ATTACHMENT0, ce, Ae);
      else
        ne(I.__webglFramebuffer, b, g, n.COLOR_ATTACHMENT0, ce, 0);
  ...
  function We(b) {
    if (b.samples > 0) {
      if (_e(b) === !1) {
        const g = b.textures, I = b.width, $ = b.height;
        ...
        for (let ve = 0; ve < g.length; ve++) {
          ...
          n.blitFramebuffer(0, 0, I, $, 0, 0, I, $, j, n.NEAREST), l === !0 && (w.length = 0, He.length = 0, w.push(n.COLOR_ATTACHMENT0 + ve), b.depthBuffer && b.resolveDepthBuffer === !1 && (w.push(k), He.push(k), n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER, He)), n.invalidateFramebuffer(n.READ_FRAMEBUFFER, w));
        }
  ...
  function Te(b, g) {
    const I = b.colorSpace, $ = b.format, j = b.type;
    return b.isCompressedTexture === !0 || b.isVideoTexture === !0 || I !== _i && I !== "" && (Ze.getTransfer(I) === it ? ($ !== 1023 || j !== 1009) && Oe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : gt("WebGLTextures: Unsupported texture color space:", I)), g;
  }
  function Ie(b) {
...
class gh {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      const t = e.cameras[0].viewport, i = new yn({
        vertexShader: mh,
        fragmentShader: xh,
        uniforms: {
      ...
      this.mesh = new Xt(new tn(20, 20), i);
    }
    return this.mesh;
  }
  /**
...
class _h extends bi {
  ...
  constructor(e, t) {
    ...
    const v = typeof XRWebGLBinding < "u", m = new gh(), h = {}, T = t.getContextAttributes();
    let y = null, A = null;
    const D = [], E = [], P = new rt();
    let O = null;
    const M = new Zt();
    ...
    function K(V) {
      const X = E.indexOf(V.inputSource);
      if (X === -1)
        return;
      const ne = D[X];
    ...
    function Y() {
      ...
      for (let V = 0; V < D.length; V++) {
        const X = E[V];
        X !== null && (E[V] = null, D[V].disconnect(X));
      }
      H = null, q = null, m.reset();
      for (const V in h)
        delete h[V];
      e.setRenderTarget(y), p = null, f = null, u = null, r = null, A = null, st.stop(), i.isPresenting = !1, e.setPixelRatio(O), e.setSize(P.width, P.height, !1), i.dispatchEvent({ type: "sessionend" });
    }
    this.setFramebufferScaleFactor = function(V) {
      ...
      if (r = V, r !== null) {
        if (y = e.getRenderTarget(), r.addEventListener("select", K), r.addEventListener("selectstart", K), r.addEventListener("selectend", K), r.addEventListener("squeeze", K), r.addEventListener("squeezestart", K), r.addEventListener("squeezeend", K), r.addEventListener("end", Y), r.addEventListener("inputsourceschange", te), T.xrCompatible !== !0 && await t.makeXRCompatible(), O = e.getPixelRatio(), e.getSize(P), v && "createProjectionLayer" in XRWebGLBinding.prototype) {
          ...
          u = this.getBinding(), f = u.createProjectionLayer(Ne), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), A = new Zn(
            f.textureWidth,
            f.textureHeight,
            {
              format: 1023,
              type: 1009,
              depthTexture: new fo(f.textureWidth, f.textureHeight, Se, void 0, void 0, void 0, void 0, void 0, void 0, ne),
          ...
          p = new XRWebGLLayer(r, t, ne), r.updateRenderState({ baseLayer: p }), e.setPixelRatio(1), e.setSize(p.framebufferWidth, p.framebufferHeight, !1), A = new Zn(
            p.framebufferWidth,
            p.framebufferHeight,
            {
              format: 1023,
    ...
    function te(V) {
      for (let X = 0; X < V.removed.length; X++) {
        const ne = V.removed[X], Se = E.indexOf(ne);
        Se >= 0 && (E[Se] = null, D[Se].disconnect(ne));
      }
    ...
    function re(V, X, ne) {
      ...
      if (X.matrixWorld.decompose(V.position, V.quaternion, V.scale), V.translateX(Te), V.translateZ(ut), V.matrixWorld.compose(V.position, V.quaternion, V.scale), V.matrixWorldInverse.copy(V.matrixWorld).invert(), ue[10] === -1)
        ...
        const Ie = xt + ut, b = Ve + ut, g = lt - Te, I = _e + (Se - Te), $ = at * Ve / b * Ie, j = w * Ve / b * Ie;
        V.projectionMatrix.makePerspective(g, I, $, j, Ie, b), V.projectionMatrixInverse.copy(V.projectionMatrix).invert();
      }
    }
    function Me(V, X) {
...
const Gn = /* @__PURE__ */ new En(), vh = /* @__PURE__ */ new bt();
function Sh(n, e) {
  function t(m, h) {
    m.matrixAutoUpdate === !0 && m.updateMatrix(), h.value.copy(m.matrix);
  }
  function i(m, h) {
    h.color.getRGB(m.fogColor.value, ao(n)), h.isFog ? (m.fogNear.value = h.near, m.fogFar.value = h.far) : h.isFogExp2 && (m.fogDensity.value = h.density);
  }
  function r(m, h, T, y, A) {
  ...
  function s(m, h) {
    ...
    const T = e.get(h), y = T.envMap, A = T.envMapRotation;
    y && (m.envMap.value = y, Gn.copy(A), Gn.x *= -1, Gn.y *= -1, Gn.z *= -1, y.isCubeTexture && y.isRenderTargetTexture === !1 && (Gn.y *= -1, Gn.z *= -1), m.envMapRotation.value.setFromMatrix4(vh.makeRotationFromEuler(Gn)), m.flipEnvMap.value = y.isCubeTexture && y.isRenderTargetTexture === !1 ? -1 : 1, m.reflectivity.value = h.reflectivity, m.ior.value = h.ior, m.refractionRatio.value = h.refractionRatio), h.lightMap && (m.lightMap.value = h.lightMap, m.lightMapIntensity.value = h.lightMapIntensity, t(h.lightMap, m.lightMapTransform)), h.aoMap && (m.aoMap.value = h.aoMap, m.aoMapIntensity.value = h.aoMapIntensity, t(h.aoMap, m.aoMapTransform));
  }
  function a(m, h) {
  ...
  function l(m, h, T, y) {
    m.diffuse.value.copy(h.color), m.opacity.value = h.opacity, m.size.value = h.size * T, m.scale.value = y * 0.5, h.map && (m.map.value = h.map, t(h.map, m.uvTransform)), h.alphaMap && (m.alphaMap.value = h.alphaMap, t(h.alphaMap, m.alphaMapTransform)), h.alphaTest > 0 && (m.alphaTest.value = h.alphaTest);
  }
  function c(m, h) {
...
function Mh(n, e, t, i) {
  ...
  function c(T, y) {
    ...
    s[T.id] !== E && (f(T), s[T.id] = E);
  }
  function d(T) {
    const y = u();
    T.__bindingPointIndex = y;
    const A = n.createBuffer(), D = T.__size, E = T.usage;
    return n.bindBuffer(n.UNIFORM_BUFFER, A), n.bufferData(n.UNIFORM_BUFFER, D, E), n.bindBuffer(n.UNIFORM_BUFFER, null), n.bindBufferBase(n.UNIFORM_BUFFER, y, A), A;
  }
  function u() {
    for (let T = 0; T < o; T++)
      if (a.indexOf(T) === -1)
  ...
  function f(T) {
    const y = r[T.id], A = T.uniforms, D = T.__cache;
    n.bindBuffer(n.UNIFORM_BUFFER, y);
    for (let E = 0, P = A.length; E < P; E++) {
      const O = Array.isArray(A[E]) ? A[E] : [A[E]];
  ...
  function p(T, y, A, D) {
    const E = T.value, P = y + "_" + A;
    if (D[P] === void 0)
      return typeof E == "number" || typeof E == "boolean" ? D[P] = E : D[P] = E.clone(), !0;
    {
      const O = D[P];
      if (typeof E == "number" || typeof E == "boolean") {
        if (O !== E)
          return D[P] = E, !0;
      } else if (O.equals(E) === !1)
        return O.copy(E), !0;
    }
    return !1;
  }
  function x(T) {
    ...
    for (let P = 0, O = y.length; P < O; P++) {
      const M = Array.isArray(y[P]) ? y[P] : [y[P]];
    ...
    const E = A % D;
    return E > 0 && (A += D - E), T.__size = A, T.__cache = {}, this;
  }
  function v(T) {
    const y = {
      boundary: 0,
    ...
    return typeof T == "number" || typeof T == "boolean" ? (y.boundary = 4, y.storage = 4) : T.isVector2 ? (y.boundary = 8, y.storage = 8) : T.isVector3 || T.isColor ? (y.boundary = 16, y.storage = 12) : T.isVector4 ? (y.boundary = 16, y.storage = 16) : T.isMatrix3 ? (y.boundary = 48, y.storage = 48) : T.isMatrix4 ? (y.boundary = 64, y.storage = 64) : T.isTexture ? Oe("WebGLRenderer: Texture samplers can not be part of an uniforms group.") : Oe("WebGLRenderer: Unsupported uniform value type.", T), y;
  }
  function m(T) {
    const y = T.target;
    y.removeEventListener("dispose", m);
    const A = a.indexOf(y.__bindingPointIndex);
    a.splice(A, 1), n.deleteBuffer(r[y.id]), delete r[y.id], delete s[y.id];
  }
  function h() {
    for (const T in r)
      n.deleteBuffer(r[T]);
...
let _n = null;
function Eh() {
  return _n === null && (_n = new Tl(bh, 32, 32, 1030, 1016), _n.minFilter = 1006, _n.magFilter = 1006, _n.wrapS = 1001, _n.wrapT = 1001, _n.generateMipmaps = !1, _n.needsUpdate = !0), _n;
}
class yh {
  /**
   * Constructs a new WebGL renderer.
  ...
  constructor(e = {}) {
    ...
    let We, lt, _e, ut, Te, Ie, b, g, I, $, j, k, be, ce, Ae, ve, J, se, Pe, Ce, he, Ue, C, de;
    function ae() {
      We = new Du(w), We.init(), Ue = new ph(w, We), lt = new bu(w, We, e, Ue), _e = new fh(w, We), lt.reversedDepthBuffer && f && _e.buffers.depth.setReversed(!0), ut = new Fu(w), Te = new Qf(), Ie = new hh(w, We, _e, Te, lt, Ue, ut), b = new yu(E), g = new Pu(E), I = new Bl(w), C = new Su(w, I), $ = new Lu(w, I, ut, C), j = new Nu(w, $, I, ut), Pe = new Iu(w, lt, Ie), ve = new Eu(Te), k = new Jf(E, b, g, We, lt, C, ve), be = new Sh(E, Te), ce = new th(), Ae = new oh(We), se = new vu(E, b, g, _e, j, p, l), J = new dh(E, j, lt), de = new Mh(w, ut, lt, _e), Ce = new Mu(w, We, ut), he = new Uu(w, We, ut), ut.programs = k.programs, E.capabilities = lt, E.extensions = We, E.properties = Te, E.renderLists = ce, E.shadowMap = J, E.state = _e, E.info = ut;
    }
    ae();
    const oe = new _h(E, w);
    this.xr = oe, this.getContext = function() {
      ...
      if (_) {
        ...
        if (F) {
          const ie = S.texture.type, fe = v.has(ie), ge = se.getClearColor(), me = se.getClearAlpha(), Re = ge.r, Le = ge.g, ye = ge.b;
          fe ? (m[0] = Re, m[1] = Le, m[2] = ye, m[3] = me, w.clearBufferuiv(w.COLOR, 0, m)) : (h[0] = Re, h[1] = Le, h[2] = ye, h[3] = me, w.clearBufferiv(w.COLOR, 0, h));
        } else
      ...
      t.removeEventListener("webglcontextlost", ee, !1), t.removeEventListener("webglcontextrestored", Z, !1), t.removeEventListener("webglcontextcreationerror", xe, !1), se.dispose(), ce.dispose(), Ae.dispose(), Te.dispose(), b.dispose(), g.dispose(), j.dispose(), C.dispose(), de.dispose(), k.dispose(), oe.dispose(), oe.removeEventListener("sessionstart", $s), oe.removeEventListener("sessionend", Ks), Un.stop();
    };
    function ee(_) {
      _.preventDefault(), ia("WebGLRenderer: Context Lost."), P = !0;
    }
    function Z() {
      ia("WebGLRenderer: Context Restored."), P = !1;
      const _ = ut.autoReset, U = J.enabled, N = J.autoUpdate, B = J.needsUpdate, F = J.type;
      ae(), ut.autoReset = _, J.enabled = U, J.autoUpdate = N, J.needsUpdate = B, J.type = F;
    }
    function xe(_) {
    ...
    function Fe(_) {
      const U = _.target;
      U.removeEventListener("dispose", Fe), ct(U);
    }
    function ct(_) {
      tt(_), Te.remove(_);
    }
    ...
    this.renderBufferDirect = function(_, U, N, B, F, ie) {
      U === null && (U = xt);
      const fe = F.isMesh && F.matrixWorld.determinant() < 0, ge = Wo(_, U, N, B, F);
      _e.setMaterial(B, fe);
      let me = N.index, Re = 1;
      if (B.wireframe === !0) {
      ...
      const Le = N.drawRange, ye = N.attributes.position;
      let Xe = Le.start * Re, nt = (Le.start + Le.count) * Re;
      ie !== null && (Xe = Math.max(Xe, ie.start * Re), nt = Math.min(nt, (ie.start + ie.count) * Re)), me !== null ? (Xe = Math.max(Xe, 0), nt = Math.min(nt, me.count)) : ye != null && (Xe = Math.max(Xe, 0), nt = Math.min(nt, ye.count));
      const pt = nt - Xe;
      if (pt < 0 || pt === 1 / 0) return;
      C.setup(F, B, ge, N, me);
      let mt, ot = Ce;
      if (me !== null && (mt = I.get(me), ot = he, ot.setIndex(mt)), F.isMesh)
        B.wireframe === !0 ? (_e.setLineWidth(B.wireframeLinewidth * at()), ot.setMode(w.LINES)) : ot.setMode(w.TRIANGLES);
      else if (F.isLine) {
        let we = B.linewidth;
        we === void 0 && (we = 1), _e.setLineWidth(we * at()), F.isLineSegments ? ot.setMode(w.LINES) : F.isLineLoop ? ot.setMode(w.LINE_LOOP) : ot.setMode(w.LINE_STRIP);
      } else F.isPoints ? ot.setMode(w.POINTS) : F.isSprite && ot.setMode(w.TRIANGLES);
      if (F.isBatchedMesh)
        if (F._multiDrawInstances !== null)
          Vi("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."), ot.renderMultiDrawInstances(F._multiDrawStarts, F._multiDrawCounts, F._multiDrawCount, F._multiDrawInstances);
        else if (We.get("WEBGL_multi_draw"))
          ot.renderMultiDraw(F._multiDrawStarts, F._multiDrawCounts, F._multiDrawCount);
        else {
          const we = F._multiDrawStarts, ft = F._multiDrawCounts, Ke = F._multiDrawCount, zt = me ? I.get(me).bytesPerElement : 1, Jn = Te.get(B).currentProgram.getUniforms();
          for (let Gt = 0; Gt < Ke; Gt++)
            Jn.setValue(w, "_gl_DrawID", Gt), ot.render(we[Gt] / zt, ft[Gt]);
        }
      else if (F.isInstancedMesh)
        ot.renderInstances(Xe, pt, F.count);
    ...
    function an(_, U, N) {
      _.transparent === !0 && _.side === 2 && _.forceSinglePass === !1 ? (_.side = 1, _.needsUpdate = !0, Ki(_, U, N), _.side = 0, _.needsUpdate = !0, Ki(_, U, N), _.side = 2) : Ki(_, U, N);
    }
    this.compile = function(_, U, N = null) {
      N === null && (N = _), y = Ae.get(N), y.init(U), D.push(y), N.traverseVisible(function(F) {
        F.isLight && F.layers.test(U.layers) && (y.pushLight(F), F.castShadow && y.pushShadow(F));
      }), _ !== N && _.traverseVisible(function(F) {
        F.isLight && F.layers.test(U.layers) && (y.pushLight(F), F.castShadow && y.pushShadow(F));
      }), y.setupLights();
      const B = /* @__PURE__ */ new Set();
      return _.traverse(function(F) {
    ...
    const Un = new po();
    Un.setAnimationLoop(Ho), typeof self < "u" && Un.setContext(self), this.setAnimationLoop = function(_) {
      jt = _, oe.setAnimationLoop(_), _ === null ? Un.stop() : Un.start();
    }, oe.addEventListener("sessionstart", $s), oe.addEventListener("sessionend", Ks), this.render = function(_, U) {
      ...
      if (_.matrixWorldAutoUpdate === !0 && _.updateMatrixWorld(), U.parent === null && U.matrixWorldAutoUpdate === !0 && U.updateMatrixWorld(), oe.enabled === !0 && oe.isPresenting === !0 && (oe.cameraAutoUpdate === !0 && oe.updateCamera(U), U = oe.getCamera()), _.isScene === !0 && _.onBeforeRender(E, _, U, S), y = Ae.get(_, D.length), y.init(U), D.push(y), Se.multiplyMatrices(U.projectionMatrix, U.matrixWorldInverse), V.setFromProjectionMatrix(Se, 2e3, U.reversedDepth), ne = this.localClippingEnabled, X = ve.init(this.clippingPlanes, ne), T = ce.get(_, A.length), T.init(), A.push(T), oe.enabled === !0 && oe.isPresenting === !0) {
        const ie = E.xr.getDepthSensingMesh();
        ie !== null && Or(ie, U, -1 / 0, E.sortObjects);
      }
      Or(_, U, 0, E.sortObjects), T.finish(), E.sortObjects === !0 && T.sort(Me, ke), Ve = oe.enabled === !1 || oe.isPresenting === !1 || oe.hasDepthSensing() === !1, Ve && se.addToRenderList(T, _), this.info.render.frame++, X === !0 && ve.beginShadows();
      const N = y.state.shadowsArray;
      J.render(N, _, U), X === !0 && ve.endShadows(), this.info.autoReset === !0 && this.info.reset();
      const B = T.opaque, F = T.transmissive;
      if (y.setupLights(), U.isArrayCamera) {
        ...
        for (let fe = 0, ge = ie.length; fe < ge; fe++) {
          const me = ie[fe];
          Zs(T, _, me, me.viewport);
        }
      } else
        F.length > 0 && js(B, F, _, U), Ve && se.render(_), Zs(T, _, U);
      S !== null && M === 0 && (Ie.updateMultisampleRenderTarget(S), Ie.updateRenderTargetMipmap(S)), _.isScene === !0 && _.onAfterRender(E, _, U), C.resetDefaultState(), L = -1, z = null, D.pop(), D.length > 0 ? (y = D[D.length - 1], X === !0 && ve.setGlobalState(E.clippingPlanes, y.state.camera)) : y = null, A.pop(), A.length > 0 ? T = A[A.length - 1] : T = null;
    };
    function Or(_, U, N, B) {
        ...
        if (_.isGroup)
          ...
          if (B && (_.boundingSphere !== void 0 ? (_.boundingSphere === null && _.computeBoundingSphere(), Ne.copy(_.boundingSphere.center)) : (fe.boundingSphere === null && fe.computeBoundingSphere(), Ne.copy(fe.boundingSphere.center)), Ne.applyMatrix4(_.matrixWorld).applyMatrix4(Se)), Array.isArray(ge)) {
            ...
            for (let Re = 0, Le = me.length; Re < Le; Re++) {
              const ye = me[Re], Xe = ge[ye.materialIndex];
              Xe && Xe.visible && T.push(_, fe, Xe, N, Ne.z, ye);
            }
    ...
    function Zs(_, U, N, B) {
      const { opaque: F, transmissive: ie, transparent: fe } = _;
      y.setupLightsView(N), X === !0 && ve.setGlobalState(E.clippingPlanes, N), B && _e.viewport(H.copy(B)), F.length > 0 && $i(F, U, N), ie.length > 0 && $i(ie, U, N), fe.length > 0 && $i(fe, U, N), _e.buffers.depth.setTest(!0), _e.buffers.depth.setMask(!0), _e.buffers.color.setMask(!0), _e.setPolygonOffset(!1);
    }
    function js(_, U, N, B) {
      if ((N.isScene === !0 ? N.overrideMaterial : null) !== null)
        return;
      y.state.transmissionRenderTarget[B.id] === void 0 && (y.state.transmissionRenderTarget[B.id] = new Zn(1, 1, {
        generateMipmaps: !0,
      ...
      const ie = y.state.transmissionRenderTarget[B.id], fe = B.viewport || H;
      ie.setSize(fe.z * E.transmissionResolutionScale, fe.w * E.transmissionResolutionScale);
      const ge = E.getRenderTarget(), me = E.getActiveCubeFace(), Re = E.getActiveMipmapLevel();
      E.setRenderTarget(ie), E.getClearColor(Y), te = E.getClearAlpha(), te < 1 && E.setClearColor(16777215, 0.5), E.clear(), Ve && se.render(N);
      const Le = E.toneMapping;
      E.toneMapping = 0;
      const ye = B.viewport;
      if (B.viewport !== void 0 && (B.viewport = void 0), y.setupLightsView(B), X === !0 && ve.setGlobalState(E.clippingPlanes, B), $i(_, N, B), Ie.updateMultisampleRenderTarget(ie), Ie.updateRenderTargetMipmap(ie), We.has("WEBGL_multisampled_render_to_texture") === !1) {
        let Xe = !1;
        for (let nt = 0, pt = U.length; nt < pt; nt++) {
          ...
          if (ft.side === 2 && ot.layers.test(B.layers)) {
            const zt = ft.side;
            ft.side = 1, ft.needsUpdate = !0, Js(ot, N, B, we, ft, Ke), ft.side = zt, ft.needsUpdate = !0, Xe = !0;
          }
        }
        Xe === !0 && (Ie.updateMultisampleRenderTarget(ie), Ie.updateRenderTargetMipmap(ie));
      }
      E.setRenderTarget(ge, me, Re), E.setClearColor(Y, te), ye !== void 0 && (B.viewport = ye), E.toneMapping = Le;
    }
    function $i(_, U, N) {
      const B = U.isScene === !0 ? U.overrideMaterial : null;
      for (let F = 0, ie = _.length; F < ie; F++) {
        const fe = _[F], { object: ge, geometry: me, group: Re } = fe;
        let Le = fe.material;
        Le.allowOverride === !0 && B !== null && (Le = B), ge.layers.test(N.layers) && Js(ge, U, N, me, Le, Re);
      }
    }
    function Js(_, U, N, B, F, ie) {
      _.onBeforeRender(E, U, N, B, F, ie), _.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse, _.matrixWorld), _.normalMatrix.getNormalMatrix(_.modelViewMatrix), F.onBeforeRender(E, U, N, B, _, ie), F.transparent === !0 && F.side === 2 && F.forceSinglePass === !1 ? (F.side = 1, F.needsUpdate = !0, E.renderBufferDirect(N, U, B, F, _, ie), F.side = 0, F.needsUpdate = !0, E.renderBufferDirect(N, U, B, F, _, ie), F.side = 2) : E.renderBufferDirect(N, U, B, F, _, ie), _.onAfterRender(E, U, N, B, F, ie);
    }
    function Ki(_, U, N) {
      U.isScene !== !0 && (U = xt);
      const B = Te.get(_), F = y.state.lights, ie = y.state.shadowsArray, fe = F.state.version, ge = k.getParameters(_, F.state, ie, U, N), me = k.getProgramCacheKey(ge);
      let Re = B.programs;
      B.environment = _.isMeshStandardMaterial ? U.environment : null, B.fog = U.fog, B.envMap = (_.isMeshStandardMaterial ? g : b).get(_.envMap || B.environment), B.envMapRotation = B.environment !== null && _.envMap === null ? U.environmentRotation : _.envMapRotation, Re === void 0 && (_.addEventListener("dispose", Fe), Re = /* @__PURE__ */ new Map(), B.programs = Re);
      let Le = Re.get(me);
      if (Le !== void 0) {
        if (B.currentProgram === Le && B.lightsStateVersion === fe)
          return ea(_, ge), Le;
      } else
        ge.uniforms = k.getUniforms(_), _.onBeforeCompile(ge, E), Le = k.acquireProgram(ge, me), Re.set(me, Le), B.uniforms = ge.uniforms;
      const ye = B.uniforms;
      return (!_.isShaderMaterial && !_.isRawShaderMaterial || _.clipping === !0) && (ye.clippingPlanes = ve.uniform), ea(_, ge), B.needsLights = qo(_), B.lightsStateVersion = fe, B.needsLights && (ye.ambientLightColor.value = F.state.ambient, ye.lightProbe.value = F.state.probe, ye.directionalLights.value = F.state.directional, ye.directionalLightShadows.value = F.state.directionalShadow, ye.spotLights.value = F.state.spot, ye.spotLightShadows.value = F.state.spotShadow, ye.rectAreaLights.value = F.state.rectArea, ye.ltc_1.value = F.state.rectAreaLTC1, ye.ltc_2.value = F.state.rectAreaLTC2, ye.pointLights.value = F.state.point, ye.pointLightShadows.value = F.state.pointShadow, ye.hemisphereLights.value = F.state.hemi, ye.directionalShadowMap.value = F.state.directionalShadowMap, ye.directionalShadowMatrix.value = F.state.directionalShadowMatrix, ye.spotShadowMap.value = F.state.spotShadowMap, ye.spotLightMatrix.value = F.state.spotLightMatrix, ye.spotLightMap.value = F.state.spotLightMap, ye.pointShadowMap.value = F.state.pointShadowMap, ye.pointShadowMatrix.value = F.state.pointShadowMatrix), B.currentProgram = Le, B.uniformsList = null, Le;
    }
    function Qs(_) {
      if (_.uniformsList === null) {
        const U = _.currentProgram.getUniforms();
        _.uniformsList = mr.seqWithValue(U.seq, _.uniforms);
      }
    ...
    function Wo(_, U, N, B, F) {
      U.isScene !== !0 && (U = xt), Ie.resetTextureUnits();
      const ie = U.fog, fe = B.isMeshStandardMaterial ? U.environment : null, ge = S === null ? E.outputColorSpace : S.isXRRenderTarget === !0 ? S.texture.colorSpace : _i, me = (B.isMeshStandardMaterial ? g : b).get(B.envMap || fe), Re = B.vertexColors === !0 && !!N.attributes.color && N.attributes.color.itemSize === 4, Le = !!N.attributes.tangent && (!!B.normalMap || B.anisotropy > 0), ye = !!N.morphAttributes.position, Xe = !!N.morphAttributes.normal, nt = !!N.morphAttributes.color;
      let pt = 0;
      B.toneMapped && (S === null || S.isXRRenderTarget === !0) && (pt = E.toneMapping);
      const mt = N.morphAttributes.position || N.morphAttributes.normal || N.morphAttributes.color, ot = mt !== void 0 ? mt.length : 0, we = Te.get(B), ft = y.state.lights;
      if (X === !0 && (ne === !0 || _ !== z)) {
        const Ut = _ === z && B.id === L;
        ve.setState(B, _, Ut);
      }
      let Ke = !1;
      B.version === we.__version ? (we.needsLights && we.lightsStateVersion !== ft.state.version || we.outputColorSpace !== ge || F.isBatchedMesh && we.batching === !1 || !F.isBatchedMesh && we.batching === !0 || F.isBatchedMesh && we.batchingColor === !0 && F.colorTexture === null || F.isBatchedMesh && we.batchingColor === !1 && F.colorTexture !== null || F.isInstancedMesh && we.instancing === !1 || !F.isInstancedMesh && we.instancing === !0 || F.isSkinnedMesh && we.skinning === !1 || !F.isSkinnedMesh && we.skinning === !0 || F.isInstancedMesh && we.instancingColor === !0 && F.instanceColor === null || F.isInstancedMesh && we.instancingColor === !1 && F.instanceColor !== null || F.isInstancedMesh && we.instancingMorph === !0 && F.morphTexture === null || F.isInstancedMesh && we.instancingMorph === !1 && F.morphTexture !== null || we.envMap !== me || B.fog === !0 && we.fog !== ie || we.numClippingPlanes !== void 0 && (we.numClippingPlanes !== ve.numPlanes || we.numIntersection !== ve.numIntersection) || we.vertexAlphas !== Re || we.vertexTangents !== Le || we.morphTargets !== ye || we.morphNormals !== Xe || we.morphColors !== nt || we.toneMapping !== pt || we.morphTargetsCount !== ot) && (Ke = !0) : (Ke = !0, we.__version = B.version);
      let zt = we.currentProgram;
      Ke === !0 && (zt = Ki(B, U, F));
      let Jn = !1, Gt = !1, yi = !1;
      const ht = zt.getUniforms(), Nt = we.uniforms;
      if (_e.useProgram(zt.program) && (Jn = !0, Gt = !0, yi = !0), B.id !== L && (L = B.id, Gt = !0), Jn || z !== _) {
        ...
        ), (B.isMeshPhongMaterial || B.isMeshToonMaterial || B.isMeshLambertMaterial || B.isMeshBasicMaterial || B.isMeshStandardMaterial || B.isShaderMaterial) && ht.setValue(w, "isOrthographic", _.isOrthographicCamera === !0), z !== _ && (z = _, Gt = !0, yi = !0);
      }
      if (F.isSkinnedMesh) {
        ht.setOptional(w, F, "bindMatrix"), ht.setOptional(w, F, "bindMatrixInverse");
        const Ut = F.skeleton;
        Ut && (Ut.boneTexture === null && Ut.computeBoneTexture(), ht.setValue(w, "boneTexture", Ut.boneTexture, Ie));
      }
      F.isBatchedMesh && (ht.setOptional(w, F, "batchingTexture"), ht.setValue(w, "batchingTexture", F._matricesTexture, Ie), ht.setOptional(w, F, "batchingIdTexture"), ht.setValue(w, "batchingIdTexture", F._indirectTexture, Ie), ht.setOptional(w, F, "batchingColorTexture"), F._colorsTexture !== null && ht.setValue(w, "batchingColorTexture", F._colorsTexture, Ie));
      const Yt = N.morphAttributes;
      if ((Yt.position !== void 0 || Yt.normal !== void 0 || Yt.color !== void 0) && Pe.update(F, N, zt), (Gt || we.receiveShadow !== F.receiveShadow) && (we.receiveShadow = F.receiveShadow, ht.setValue(w, "receiveShadow", F.receiveShadow)), B.isMeshGouraudMaterial && B.envMap !== null && (Nt.envMap.value = me, Nt.flipEnvMap.value = me.isCubeTexture && me.isRenderTargetTexture === !1 ? -1 : 1), B.isMeshStandardMaterial && B.envMap === null && U.environment !== null && (Nt.envMapIntensity.value = U.environmentIntensity), Nt.dfgLUT !== void 0 && (Nt.dfgLUT.value = Eh()), Gt && (ht.setValue(w, "toneMappingExposure", E.toneMappingExposure), we.needsLights && Xo(Nt, yi), ie && B.fog === !0 && be.refreshFogUniforms(Nt, ie), be.refreshMaterialUniforms(Nt, B, re, Q, y.state.transmissionRenderTarget[_.id]), mr.upload(w, Qs(we), Nt, Ie)), B.isShaderMaterial && B.uniformsNeedUpdate === !0 && (mr.upload(w, Qs(we), Nt, Ie), B.uniformsNeedUpdate = !1), B.isSpriteMaterial && ht.setValue(w, "center", F.center), ht.setValue(w, "modelViewMatrix", F.modelViewMatrix), ht.setValue(w, "normalMatrix", F.normalMatrix), ht.setValue(w, "modelMatrix", F.matrixWorld), B.isShaderMaterial || B.isRawShaderMaterial) {
        const Ut = B.uniformsGroups;
        for (let Ot = 0, Br = Ut.length; Ot < Br; Ot++) {
          const Fn = Ut[Ot];
          de.update(Fn, zt), de.bind(Fn, zt);
        }
      }
      return zt;
    }
    ...
    const Yo = w.createFramebuffer();
    this.setRenderTarget = function(_, U = 0, N = 0) {
      S = _, O = U, M = N;
      let B = !0, F = null, ie = !1, fe = !1;
      if (_) {
        const me = Te.get(_);
        if (me.__useDefaultFramebuffer !== void 0)
          _e.bindFramebuffer(w.FRAMEBUFFER, null), B = !1;
        else if (me.__webglFramebuffer === void 0)
          Ie.setupRenderTarget(_);
        else if (me.__hasExternalTextures)
          Ie.rebindTextures(_, Te.get(_.texture).__webglTexture, Te.get(_.depthTexture).__webglTexture);
        else if (_.depthBuffer) {
          const ye = _.depthTexture;
          if (me.__boundDepthTexture !== ye) {
            if (ye !== null && Te.has(ye) && (_.width !== ye.image.width || _.height !== ye.image.height))
              throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");
            Ie.setupDepthRenderbuffer(_);
          }
        }
        const Re = _.texture;
        (Re.isData3DTexture || Re.isDataArrayTexture || Re.isCompressedArrayTexture) && (fe = !0);
        const Le = Te.get(_).__webglFramebuffer;
        _.isWebGLCubeRenderTarget ? (Array.isArray(Le[U]) ? F = Le[U][N] : F = Le[U], ie = !0) : _.samples > 0 && Ie.useMultisampledRTT(_) === !1 ? F = Te.get(_).__webglMultisampledFramebuffer : Array.isArray(Le) ? F = Le[N] : F = Le, H.copy(_.viewport), q.copy(_.scissor), K = _.scissorTest;
      } else
        H.copy(et).multiplyScalar(re).floor(), q.copy(je).multiplyScalar(re).floor(), K = st;
      if (N !== 0 && (F = Yo), _e.bindFramebuffer(w.FRAMEBUFFER, F) && B && _e.drawBuffers(_, F), _e.viewport(H), _e.scissor(q), _e.setScissorTest(K), ie) {
      ...
      L = -1;
    }, this.readRenderTargetPixels = function(_, U, N, B, F, ie, fe, ge = 0) {
      ...
      if (_.isWebGLCubeRenderTarget && fe !== void 0 && (me = me[fe]), me) {
        ...
        try {
          const Re = _.textures[ge], Le = Re.format, ye = Re.type;
          ...
          if (!lt.textureTypeReadable(ye)) {
            gt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");
            return;
          }
          U >= 0 && U <= _.width - B && N >= 0 && N <= _.height - F && (_.textures.length > 1 && w.readBuffer(w.COLOR_ATTACHMENT0 + ge), w.readPixels(U, N, B, F, Ue.convert(Le), Ue.convert(ye), ie));
        } finally {
          const Re = S !== null ? Te.get(S).__webglFramebuffer : null;
          _e.bindFramebuffer(w.FRAMEBUFFER, Re);
        }
      }
    }, this.readRenderTargetPixelsAsync = async function(_, U, N, B, F, ie, fe, ge = 0) {
      if (!(_ && _.isWebGLRenderTarget))
        throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");
      let me = Te.get(_).__webglFramebuffer;
      if (_.isWebGLCubeRenderTarget && fe !== void 0 && (me = me[fe]), me)
        if (U >= 0 && U <= _.width - B && N >= 0 && N <= _.height - F) {
          _e.bindFramebuffer(w.FRAMEBUFFER, me);
          const Re = _.textures[ge], Le = Re.format, ye = Re.type;
          if (!lt.textureFormatReadable(Le))
          ...
          w.bindBuffer(w.PIXEL_PACK_BUFFER, Xe), w.bufferData(w.PIXEL_PACK_BUFFER, ie.byteLength, w.STREAM_READ), _.textures.length > 1 && w.readBuffer(w.COLOR_ATTACHMENT0 + ge), w.readPixels(U, N, B, F, Ue.convert(Le), Ue.convert(ye), 0);
          ...
          return w.flush(), await jo(w, pt, 4), w.bindBuffer(w.PIXEL_PACK_BUFFER, Xe), w.getBufferSubData(w.PIXEL_PACK_BUFFER, 0, ie), w.deleteBuffer(Xe), w.deleteSync(pt), ie;
        } else
          throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.");
    }, this.copyFramebufferToTexture = function(_, U = null, N = 0) {
      const B = Math.pow(2, -N), F = Math.floor(_.image.width * B), ie = Math.floor(_.image.height * B), fe = U !== null ? U.x : 0, ge = U !== null ? U.y : 0;
      Ie.setTexture2D(_, 0), w.copyTexSubImage2D(w.TEXTURE_2D, N, 0, 0, fe, ge, F, ie), _e.unbindTexture();
    };
    const $o = w.createFramebuffer(), Ko = w.createFramebuffer();
    this.copyTextureToTexture = function(_, U, N = null, B = null, F = 0, ie = null) {
      ie === null && (F !== 0 ? (Vi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."), ie = F, F = 0) : ie = 0);
      let fe, ge, me, Re, Le, ye, Xe, nt, pt;
      const mt = _.isCompressedTexture ? _.mipmaps[ie] : _.image;
      if (N !== null)
        fe = N.max.x - N.min.x, ge = N.max.y - N.min.y, me = N.isBox3 ? N.max.z - N.min.z : 1, Re = N.min.x, Le = N.min.y, ye = N.isBox3 ? N.min.z : 0;
      else {
        const Yt = Math.pow(2, -F);
        fe = Math.floor(mt.width * Yt), ge = Math.floor(mt.height * Yt), _.isDataArrayTexture ? me = mt.depth : _.isData3DTexture ? me = Math.floor(mt.depth * Yt) : me = 1, Re = 0, Le = 0, ye = 0;
      }
      B !== null ? (Xe = B.x, nt = B.y, pt = B.z) : (Xe = 0, nt = 0, pt = 0);
      const ot = Ue.convert(U.format), we = Ue.convert(U.type);
      let ft;
      U.isData3DTexture ? (Ie.setTexture3D(U, 0), ft = w.TEXTURE_3D) : U.isDataArrayTexture || U.isCompressedArrayTexture ? (Ie.setTexture2DArray(U, 0), ft = w.TEXTURE_2D_ARRAY) : (Ie.setTexture2D(U, 0), ft = w.TEXTURE_2D), w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL, U.flipY), w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL, U.premultiplyAlpha), w.pixelStorei(w.UNPACK_ALIGNMENT, U.unpackAlignment);
      const Ke = w.getParameter(w.UNPACK_ROW_LENGTH), zt = w.getParameter(w.UNPACK_IMAGE_HEIGHT), Jn = w.getParameter(w.UNPACK_SKIP_PIXELS), Gt = w.getParameter(w.UNPACK_SKIP_ROWS), yi = w.getParameter(w.UNPACK_SKIP_IMAGES);
      w.pixelStorei(w.UNPACK_ROW_LENGTH, mt.width), w.pixelStorei(w.UNPACK_IMAGE_HEIGHT, mt.height), w.pixelStorei(w.UNPACK_SKIP_PIXELS, Re), w.pixelStorei(w.UNPACK_SKIP_ROWS, Le), w.pixelStorei(w.UNPACK_SKIP_IMAGES, ye);
      ...
      if (_.isDepthTexture) {
        ...
        for (let Fn = 0; Fn < me; Fn++)
          ht && (w.framebufferTextureLayer(w.READ_FRAMEBUFFER, w.COLOR_ATTACHMENT0, Te.get(_).__webglTexture, F, ye + Fn), w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER, w.COLOR_ATTACHMENT0, Te.get(U).__webglTexture, ie, pt + Fn)), w.blitFramebuffer(Re, Le, fe, ge, Xe, nt, fe, ge, w.DEPTH_BUFFER_BIT, w.NEAREST);
        _e.bindFramebuffer(w.READ_FRAMEBUFFER, null), _e.bindFramebuffer(w.DRAW_FRAMEBUFFER, null);
      } else if (F !== 0 || _.isRenderTargetTexture || Te.has(_)) {
        const Yt = Te.get(_), Ut = Te.get(U);
        _e.bindFramebuffer(w.READ_FRAMEBUFFER, $o), _e.bindFramebuffer(w.DRAW_FRAMEBUFFER, Ko);
        for (let Ot = 0; Ot < me; Ot++)
          ht ? w.framebufferTextureLayer(w.READ_FRAMEBUFFER, w.COLOR_ATTACHMENT0, Yt.__webglTexture, F, ye + Ot) : w.framebufferTexture2D(w.READ_FRAMEBUFFER, w.COLOR_ATTACHMENT0, w.TEXTURE_2D, Yt.__webglTexture, F), Nt ? w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER, w.COLOR_ATTACHMENT0, Ut.__webglTexture, ie, pt + Ot) : w.framebufferTexture2D(w.DRAW_FRAMEBUFFER, w.COLOR_ATTACHMENT0, w.TEXTURE_2D, Ut.__webglTexture, ie), F !== 0 ? w.blitFramebuffer(Re, Le, fe, ge, Xe, nt, fe, ge, w.COLOR_BUFFER_BIT, w.NEAREST) : Nt ? w.copyTexSubImage3D(ft, ie, Xe, nt, pt + Ot, Re, Le, fe, ge) : w.copyTexSubImage2D(ft, ie, Xe, nt, Re, Le, fe, ge);
        _e.bindFramebuffer(w.READ_FRAMEBUFFER, null), _e.bindFramebuffer(w.DRAW_FRAMEBUFFER, null);
      } else
      ...
      w.pixelStorei(w.UNPACK_ROW_LENGTH, Ke), w.pixelStorei(w.UNPACK_IMAGE_HEIGHT, zt), w.pixelStorei(w.UNPACK_SKIP_PIXELS, Jn), w.pixelStorei(w.UNPACK_SKIP_ROWS, Gt), w.pixelStorei(w.UNPACK_SKIP_IMAGES, yi), ie === 0 && U.generateMipmaps && w.generateMipmap(ft), _e.unbindTexture();
    }, this.initRenderTarget = function(_) {
      Te.get(_).__webglFramebuffer === void 0 && Ie.setupRenderTarget(_);
    }, this.initTexture = function(_) {
      _.isCubeTexture ? Ie.setTextureCube(_, 0) : _.isData3DTexture ? Ie.setTexture3D(_, 0) : _.isDataArrayTexture || _.isCompressedArrayTexture ? Ie.setTexture2DArray(_, 0) : Ie.setTexture2D(_, 0), _e.unbindTexture();
...
const Th = ["expanded", "compact"], Ah = ["expand", "collapse", "expand_collapse", "collapse_expand"], wh = ["expanded", "compact", "both", "none"], Ch = ["linear", "easeInOutCubic", "easeOutCubic", "easeInCubic"], Wa = /^[0-9]+(\.[0-9]+)?%?$/;
function rn(n, e, t) {
...
function Rh(n) {
  ...
  const e = sn(n, "size");
  return rn(e, /* @__PURE__ */ new Set(["width", "height"]), "size"), {
    width: e.width === void 0 ? 1920 : Er(e.width, "size.width", { min: 1 }),
    height: e.height === void 0 ? 1080 : Er(e.height, "size.height", { min: 1 })
  };
}
function Ph(n) {
  ...
  if (typeof n == "string") {
    if (!Wa.test(n.trim()))
      throw new Error(`camera.distance string must match ${Wa} (got ${JSON.stringify(n)})`);
    return n;
  }
...
function Dh(n) {
  ...
  const e = sn(n, "camera");
  return rn(e, /* @__PURE__ */ new Set(["gap", "distance", "angle", "elevation", "fov"]), "camera"), {
    gap: e.gap === void 0 ? 1920 : Ct(e.gap, "camera.gap", { min: 0 }),
    distance: Ph(e.distance),
...
function Lh(n) {
  ...
  const e = sn(n, "transition");
  if (rn(e, /* @__PURE__ */ new Set(["kind", "duration", "wait", "fps", "easing"]), "transition"), e.kind === void 0) throw new Error("transition.kind is required");
  return {
    kind: yr(e.kind, Ah, "transition.kind"),
    duration: e.duration === void 0 ? 3 : Ct(e.duration, "transition.duration", { gt: 0 }),
    wait: e.wait === void 0 ? 1 : Ct(e.wait, "transition.wait", { min: 0 }),
    fps: e.fps === void 0 ? 30 : Er(e.fps, "transition.fps", { min: 1 }),
    easing: e.easing === void 0 ? "easeInOutCubic" : yr(e.easing, Ch, "transition.easing")
  };
}
function Uh(n) {
  if (n === void 0) return { color: "#1a1a1a", opacity: 0.04, reflectivity: 0.5 };
  const e = sn(n, "floor");
  return rn(e, /* @__PURE__ */ new Set(["color", "opacity", "reflectivity"]), "floor"), {
    color: e.color === void 0 ? "#1a1a1a" : Sn(e.color, "floor.color"),
    opacity: e.opacity === void 0 ? 0.04 : Ct(e.opacity, "floor.opacity", { min: 0, max: 1 }),
    reflectivity: e.reflectivity === void 0 ? 0.5 : Ct(e.reflectivity, "floor.reflectivity", { min: 0, max: 1 })
  };
}
function Fh(n) {
  if (n === void 0) return { width: 0, color: "#f2f2f2" };
  const e = sn(n, "edge");
  return rn(e, /* @__PURE__ */ new Set(["width", "color"]), "edge"), {
...
function vo(n, e) {
  if (n === void 0) return null;
  const t = sn(n, e);
  rn(t, /* @__PURE__ */ new Set(["size", "color", "font", "fill_color", "border_color"]), e);
  const i = {};
...
function Ih(n) {
  if (n === void 0) return null;
  const e = sn(n, "caption_fade");
  return rn(e, /* @__PURE__ */ new Set(["window", "stagger", "stagger_frames"]), "caption_fade"), {
    ...
    stagger_frames: e.stagger_frames === void 0 || e.stagger_frames === null ? null : Er(e.stagger_frames, "caption_fade.stagger_frames", { min: 0 })
  };
}
function Nh(n, e) {
  if (n === void 0) return null;
  const t = sn(n, e);
  if (rn(t, /* @__PURE__ */ new Set(["text", "show_in", "style"]), e), t.text === void 0) throw new Error(`${e}.text is required`);
  return {
    text: Sn(t.text, `${e}.text`),
    show_in: t.show_in === void 0 ? "expanded" : yr(t.show_in, wh, `${e}.show_in`),
    style: vo(t.style, `${e}.style`)
  };
}
function Oh(n, e) {
  ...
  const t = sn(n, e);
  return rn(t, /* @__PURE__ */ new Set(["expanded", "compact"]), e), {
...
function Bh(n, e) {
  const t = `slides[${e}]`, i = sn(n, t);
  if (rn(i, /* @__PURE__ */ new Set(["src", "gap", "opacity", "caption"]), t), i.src === void 0) throw new Error(`${t}.src is required`);
  let r = null;
  return i.gap !== void 0 && i.gap !== null && (r = Ct(i.gap, `${t}.gap`, { min: 0 })), {
    src: Sn(i.src, `${t}.src`),
    gap: r,
    opacity: Oh(i.opacity, `${t}.opacity`),
    caption: Nh(i.caption, `${t}.caption`)
  };
}
function vs(n, e) {
  const t = n.opacity;
...
function zh(n) {
  ...
  return {
    version: 1,
    view: e.view === void 0 ? "expanded" : yr(e.view, Th, "view"),
    size: Rh(e.size),
    camera: Dh(e.camera),
    transition: Lh(e.transition),
    floor: Uh(e.floor),
    edge: Fh(e.edge),
    background: e.background === void 0 ? "#ffffff" : Sn(e.background, "background"),
    juicy: e.juicy === void 0 ? !1 : Xa(e.juicy, "juicy"),
    ...
    captions: e.captions === void 0 ? !0 : Xa(e.captions, "captions"),
    caption_defaults: vo(e.caption_defaults, "caption_defaults"),
    caption_fade: Ih(e.caption_fade),
    slides: e.slides.map((i, r) => Bh(i, r))
  };
}
function Gh(n, e) {
...
const Tr = 3, qa = 0.85, kh = 0.98, Hh = 0.9, Wh = 0.3, Xh = 0, qh = 0.1 * 4 / 3, So = 0.75, Yh = 0.75, $h = qh * So, Kh = 0.02;
function Zh(n) {
  return n.size.height * n.edge.width;
}
function Us(n) {
  const e = n.caption_defaults;
  return e && e.size !== null && e.size !== void 0 ? Number(e.size) : Math.max(8, n.size.height * $h);
}
function jh(n) {
  const e = n.caption_defaults;
...
function Qh(n) {
  return -(n.size.height / 2) + Fs(n) / 2;
}
function Is(n) {
  return n.captions ? Fs(n) : 0;
}
function ep(n) {
  return -(n.size.width / 2 + Xh * Us(n));
}
function Ir(n) {
...
const Ya = (n, e) => [n[0] - e[0], n[1] - e[1], n[2] - e[2]], hi = (n, e) => n[0] * e[0] + n[1] * e[1] + n[2] * e[2], $a = (n, e) => [
  n[1] * e[2] - n[2] * e[1],
  n[2] * e[0] - n[0] * e[2],
  n[0] * e[1] - n[1] * e[0]
];
...
function Mo(n, e) {
  const t = n.camera, r = [0, 0, -Ns(n, "expanded") / 2], s = t.angle * Math.PI / 180, a = t.elevation * Math.PI / 180, o = ms([
    -Math.sin(s) * Math.cos(a),
    Math.sin(a),
    Math.cos(s) * Math.cos(a)
  ]), l = [-o[0], -o[1], -o[2]], c = [0, 1, 0];
  let d = $a(l, c);
  d = Math.abs(hi(l, c)) < 0.999 ? ms(d) : [1, 0, 0];
  const u = ms($a(d, l)), f = t.fov * Math.PI / 180, p = e || n.size.width / n.size.height, x = 2 * Math.atan(Math.tan(f / 2) / p), v = Math.tan(f / 2), m = Math.tan(x / 2), h = n.size.width / 2, T = n.size.height / 2, y = tp(Ir(n)), A = Is(n), D = -T, E = A - T, P = A + T, O = n.captions ? [D] : [], M = [], S = [];
  for (const V of y) {
    const X = Ya([0, A, V], r);
    S.push([hi(X, d), hi(X, l)]);
    for (const ne of [-h, h])
      for (const Se of [E, P, ...O]) {
        const ue = Ya([ne, Se, V], r);
        M.push([hi(ue, d), hi(ue, u), hi(ue, l)]);
      }
  }
  const L = (V, X) => {
  ...
  const Y = Math.max(q / (qa * v), K / (qa * m));
...
function bo(n, e) {
  const t = n.camera, i = Ns(n, "compact"), r = Is(n), s = n.size.height + r, a = [0, r / 2, -i / 2];
  let o = !1, l = 90;
  if (typeof t.distance == "string") {
    const f = t.distance.trim();
    if (f.endsWith("%")) {
      o = !0;
      const p = parseFloat(f.slice(0, -1));
      isNaN(p) || (l = p);
    }
  }
  let c;
  if (o) {
    const f = t.fov * Math.PI / 180, p = e || n.size.width / n.size.height, x = 2 * Math.atan(Math.tan(f / 2) / p), v = l / 100, m = n.size.width / (2 * Math.tan(f / 2) * v), h = s / (2 * Math.tan(x / 2) * v);
    c = Math.max(m, h) + i / 2;
  } else
    c = np(t.distance, n.size.width);
  const d = Math.max(1, c * 5e-3);
  return { position: [a[0], a[1], a[2] + c], target: a, fov: t.fov, near: d };
}
function Eo(n, e) {
...
function ip(n, e) {
  const t = Math.max(0, Math.min(1, e)), i = vs(n, "compact"), r = vs(n, "expanded"), s = i + (r - i) * t;
  return Math.max(0, Math.min(1, s));
}
function Ss(n, e) {
  const t = Math.max(0, Math.min(1, e));
  if (!n.captions) return n.slides.map(() => 0);
  const i = n.caption_fade, r = i ? i.window : Hh, s = i ? i.stagger : Wh, a = n.slides.length, o = a > 1 ? a - 1 : 1;
  let l = s * r;
...
function rp(n, e, t) {
  return {
    position: Ka(n.position, e.position, t),
    target: Ka(n.target, e.target, t),
    fov: n.fov + (e.fov - n.fov) * t,
    near: n.near + (e.near - n.near) * t
  };
}
function sp(n, e, t, i) {
  const s = Ir(n).map((o) => Tr + (o - Tr) * i), a = n.slides.map((o) => ip(o, i));
  return {
    camera: rp(e, t, i),
    gaps: s,
    opacities: a,
    captionOpacities: Ss(n, i)
  };
}
function xr(n, e, t) {
  const i = bo(n, t), r = Mo(n, t);
  return sp(n, i, r, Math.max(0, Math.min(1, e)));
}
function ap(n, e) {
  ...
  const T = m.measureText(n).width / c + 2 * Yh * t, y = r, A = Math.max(1, Math.round(T * c)), D = Math.max(1, Math.round(y * c)), E = document.createElement("canvas");
  E.width = A, E.height = D;
  ...
  const M = new uo(E);
  M.colorSpace = It, M.needsUpdate = !0;
  const S = new Yn({
    map: M,
    transparent: !0,
    depthTest: !1,
...
function lp(n) {
  ...
  if (!t || !i) return null;
  const r = Math.max(0, Kh * i), s = Math.ceil(r * 3) + 1, a = document.createElement("canvas");
  a.width = t + s * 2, a.height = i + s * 2;
  const o = a.getContext("2d");
  if (!o) return null;
  typeof o.filter == "string" && (o.filter = `blur(${r}px)`), o.drawImage(e, s, s, t, i);
  const l = new uo(a);
  return l.colorSpace = It, l.needsUpdate = !0, { texture: l, padFrac: [(t + s * 2) / t, (i + s * 2) / i] };
}
class cp {
  /**
  ...
  async init() {
    ...
    return this.threeScene = new yl(), this.threeScene.background = new Qe(this.scene.background), this.camera = new Zt(
      this.scene.camera.fov,
      r / s,
      1,
      1e6
    ), this.renderer = new yh({ antialias: !0, alpha: !0, preserveDrawingBuffer: !0 }), this.renderer.setPixelRatio(typeof window < "u" ? window.devicePixelRatio : 1), this.renderer.setSize(r, s), this.container.appendChild(this.renderer.domElement), await this._buildPlates(), this._buildFloor(), await this._ensureCaptionFonts(), this._buildCaptions(), this.setView(this.view), this;
  }
  async _buildPlates() {
    const e = new Fl(), t = await Promise.all(this.scene.slides.map((a) => op(e, a.src))), i = this.scene.floor.reflectivity, r = t.reduce((a, o) => Math.max(a, o.image.width), 0) || this.scene.size.width;
    this._texScale = this.scene.size.width / r;
    const s = this.scene.edge;
    this._edgeWidth = s.width > 0 ? Zh(this.scene) : 0, this._edgeColor = s.color, t.forEach((a, o) => {
      const l = a.image.width * this._texScale, c = a.image.height * this._texScale, d = new tn(l, c), u = new Yn({
        map: a,
        side: 2,
        transparent: !0,
        depthWrite: !1,
      ...
      f.renderOrder = 0, this.threeScene.add(f);
      let p = null;
      if (i > 0) {
        const v = lp(a), m = v ? v.texture : a, h = new Yn({
          map: m,
          side: 2,
          transparent: !0,
          depthWrite: !1,
      ...
      let x = null;
      this._edgeWidth > 0 && (x = this._makeBorder(l, c, this._edgeWidth, this._edgeColor), x.group.renderOrder = 1, this.threeScene.add(x.group)), this.plates.push({
        mesh: f,
        reflection: p,
        border: x,
        width: l,
  ...
  _makeBorder(e, t, i, r) {
    const s = new Yn({
      ...
      transparent: !0,
      opacity: 1
    }), a = new Di(), o = e / 2, l = t / 2, d = [
      { geo: new tn(e, i), x: 0, y: l - i / 2 },
      // top
      { geo: new tn(e, i), x: 0, y: -l + i / 2 },
      // bottom
      { geo: new tn(i, t - 2 * i), x: -o + i / 2, y: 0 },
      // left
      { geo: new tn(i, t - 2 * i), x: o - i / 2, y: 0 }
      // right
    ].map(({ geo: u, x: f, y: p }) => {
  ...
  _buildCaptions() {
    ...
    const e = this.scene.caption_defaults ?? null, t = Us(this.scene), i = Fs(this.scene), r = this._edgeWidth, s = this._edgeColor, a = jh(this.scene), o = Jh(this.scene);
    this.plates.forEach((l, c) => {
      ...
      const u = {
        ...
        fillColor: a,
        borderColor: o
      }, { mesh: f, material: p, worldWidth: x } = ap(d.text, u);
      f.renderOrder = 2, this.threeScene.add(f), this.captions.push({ sprite: f, material: p, plateIndex: c, caption: d, worldWidth: x });
    });
  }
  _tallestHeight() {
  ...
  _buildFloor() {
    const e = this.plates.reduce((l, c) => Math.max(l, c.width), 0) || this.scene.size.width, t = Ns(this.scene, "expanded"), i = e * 4, r = t > 0 ? t + e * 2 : e * 2, s = new tn(i, r), a = new Yn({
  ...
  setView(e) {
    this.view = e;
    const t = e === "compact" ? this.plates.map(() => Tr) : Ir(this.scene), i = this.plates.map((o) => vs(o.slide, e)), r = this.camera.aspect || void 0, s = e === "compact" ? bo(this.scene, r) : Mo(this.scene, r), a = e === "compact" ? 0 : 1;
    this._placePlates(t, i), this._placeCaptions(Ss(this.scene, a)), this._applyPose(s);
  }
  /**
  ...
  applyFrameState(e, t) {
    ...
    const i = e.captionOpacities ?? Ss(this.scene, t);
    this._placeCaptions(i), this._applyPose(e.camera);
  }
  /** Lay out plates along Z (index 0 farthest), bottom-aligned, with opacities. */
  _placePlates(e, t) {
    const r = -this._tallestHeight() / 2, s = r, a = this.scene.floor.reflectivity, o = Is(this.scene);
    let l = 0;
  ...
  _placeCaptions(e) {
    ...
    const t = ep(this.scene), i = Qh(this.scene);
...
function To(n, { duration: e, wait: t }) {
  const i = yo[n];
...
function Za(n, e, t = {}) {
  ...
  const s = i?.duration ?? 3, a = i?.wait ?? 0, o = i?.easing ?? "easeInOutCubic", l = To(r, { duration: s, wait: a }), c = t.clock?.now ?? (() => performance.now()), d = t.clock?.raf ?? (typeof requestAnimationFrame < "u" ? requestAnimationFrame : (A) => setTimeout(() => A(c()), 16)), u = t.clock?.caf ?? (typeof cancelAnimationFrame < "u" ? cancelAnimationFrame : (A) => clearTimeout(A));
  let f = null, p = !1, x, v;
  const m = new Promise((A, D) => {
    x = A, v = D;
  }), h = l.totalSeconds * 1e3, T = c(), y = () => {
    if (p) {
      v(new Error("transition cancelled"));
      return;
    }
    const A = c() - T, D = h > 0 ? Math.min(1, A / h) : 1, E = Ao(l, D, (P) => Eo(o, P));
    if (e(xr(n, E)), t.onProgress?.(D), D >= 1) {
      x();
      return;
    }
    f = d(y);
...
function fp({ trigger: n, onProgress: e, reducedMotion: t, win: i } = {}) {
  ...
  const s = t ?? up(), a = () => {
    const x = n.getBoundingClientRect(), v = ja(x, r.innerHeight);
    e(v < 0.5 ? 0 : 1);
  };
  if (s) {
    a();
...
var Os = (n, e, t) => {
...
}, R = (n, e, t) => (Os(n, e, "read from private field"), t ? t.call(n) : e.get(n)), Ge = (n, e, t) => {
  if (e.has(n))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(n) : e.set(n, t);
}, wt = (n, e, t, i) => (Os(n, e, "write to private field"), e.set(n, t), t), hp = (n, e, t, i) => ({
  set _(r) {
    wt(n, e, r);
  },
  get _() {
...
}), qe = (n, e, t) => (Os(n, e, "access private method"), t), $e = new Uint8Array(8), fn = new DataView($e.buffer), Mt = (n) => [(n % 256 + 256) % 256], Je = (n) => (fn.setUint16(0, n, !1), [$e[0], $e[1]]), pp = (n) => (fn.setInt16(0, n, !1), [$e[0], $e[1]]), wo = (n) => (fn.setUint32(0, n, !1), [$e[1], $e[2], $e[3]]), pe = (n) => (fn.setUint32(0, n, !1), [$e[0], $e[1], $e[2], $e[3]]), mp = (n) => (fn.setInt32(0, n, !1), [$e[0], $e[1], $e[2], $e[3]]), jn = (n) => (fn.setUint32(0, Math.floor(n / 2 ** 32), !1), fn.setUint32(4, n, !1), [$e[0], $e[1], $e[2], $e[3], $e[4], $e[5], $e[6], $e[7]]), Bs = (n) => (fn.setInt16(0, 2 ** 8 * n, !1), [$e[0], $e[1]]), cn = (n) => (fn.setInt32(0, 2 ** 16 * n, !1), [$e[0], $e[1], $e[2], $e[3]]), xs = (n) => (fn.setInt32(0, 2 ** 30 * n, !1), [$e[0], $e[1], $e[2], $e[3]]), Kt = (n, e = !1) => {
  let t = Array(n.length).fill(null).map((i, r) => n.charCodeAt(r));
  return e && t.push(0), t;
}, Ar = (n) => n && n[n.length - 1], zs = (n) => {
  let e;
  for (let t of n)
  ...
  cn(n[7]),
  xs(n[8])
], Ii = (n) => !n || typeof n != "object" ? n : Array.isArray(n) ? n.map(Ii) : Object.fromEntries(Object.entries(n).map(([e, t]) => [e, Ii(t)])), Si = (n) => n >= 0 && n < 2 ** 32, St = (n, e, t) => ({
  type: n,
...
}, Ms = (n) => ({ type: "mdat", largeSize: n }), gp = (n) => ({ type: "free", size: n }), gr = (n, e, t = !1) => St("moov", null, [
  _p(e, n),
  ...n.map((i) => vp(i, e)),
  t ? Zp(n) : null
]), _p = (n, e) => {
  let t = un(Math.max(
    ...
    ...e.filter((a) => a.samples.length > 0).map((a) => {
      const o = zs(a.samples);
      return o.presentationTimestamp + o.duration;
    })
  ), ys), i = Math.max(...e.map((a) => a.id)) + 1, r = !Si(n) || !Si(t), s = r ? jn : pe;
  return dt("mvhd", +r, 0, [
    s(n),
    // Creation time
    s(n),
  ...
  let t = zs(n.samples), i = un(
    t ? t.presentationTimestamp + t.duration : 0,
    ys
  ), r = !Si(e) || !Si(i), s = r ? jn : pe, a;
  return n.info.type === "video" ? a = typeof n.info.rotation == "number" ? Co(n.info.rotation) : n.info.rotation : a = Ro, dt("tkhd", +r, 3, [
    s(e),
    // Creation time
    s(e),
    // Modification time
  ...
  bp(n, e),
  Ep(n.info.type === "video" ? "vide" : "soun"),
  yp(n)
]), bp = (n, e) => {
  let t = zs(n.samples), i = un(
    t ? t.presentationTimestamp + t.duration : 0,
    n.timescale
  ), r = !Si(e) || !Si(i), s = r ? jn : pe;
  return dt("mdhd", +r, 0, [
    s(e),
    // Creation time
    s(e),
  ...
  om[e.info.codec](e),
  e.info.decoderConfig.colorSpace ? Np(e) : null
]), Up = {
  bt709: 1,
  // ITU-R BT.709
  bt470bg: 5,
  ...
  Kt("nclx"),
  // Colour type
  Je(Up[n.info.decoderConfig.colorSpace.primaries]),
  // Colour primaries
  Je(Fp[n.info.decoderConfig.colorSpace.transfer]),
  // Transfer characteristics
  Je(Ip[n.info.decoderConfig.colorSpace.matrix]),
  // Matrix coefficients
  Mt((n.info.decoderConfig.colorSpace.fullRange ? 1 : 0) << 7)
  // Full range flag
]), Op = (n) => n.info.decoderConfig && St("avcC", [
  // For AVC, description is an AVCDecoderConfigurationRecord, so nothing else to do here
  ...new Uint8Array(n.info.decoderConfig.description)
]), Bp = (n) => n.info.decoderConfig && St("hvcC", [
  ...
  // Sample size table
]), $p = (n) => n.finalizedChunks.length > 0 && Ar(n.finalizedChunks).offset >= 2 ** 32 ? dt("co64", 0, 0, [
...
]), Zp = (n) => St("mvex", null, n.map(jp)), jp = (n) => dt("trex", 0, 0, [
  pe(n.id),
  // Track ID
  pe(1),
  ...
  constructor() {
    this.pos = 0, Ge(this, kn, new Uint8Array(8)), Ge(this, pi, new DataView(R(this, kn).buffer)), this.offsets = /* @__PURE__ */ new WeakMap();
  }
  ...
  writeU32(n) {
    R(this, pi).setUint32(0, n, !1), this.write(R(this, kn).subarray(0, 4));
  }
  writeU64(n) {
    R(this, pi).setUint32(0, Math.floor(n / 2 ** 32), !1), R(this, pi).setUint32(4, n, !1), this.write(R(this, kn).subarray(0, 8));
  }
  writeAscii(n) {
    for (let e = 0; e < n.length; e++)
      R(this, pi).setUint8(e % 8, n.charCodeAt(e)), e % 8 === 7 && this.write(R(this, kn));
...
var _r, Kn, ki, Ui, vr, bs, um = class extends Fo {
  constructor(n) {
    super(), Ge(this, vr), Ge(this, _r, void 0), Ge(this, Kn, new ArrayBuffer(2 ** 16)), Ge(this, ki, new Uint8Array(R(this, Kn))), Ge(this, Ui, 0), wt(this, _r, n);
  }
  write(n) {
    qe(this, vr, bs).call(this, this.pos + n.byteLength), R(this, ki).set(n, this.pos), this.pos += n.byteLength, wt(this, Ui, Math.max(R(this, Ui), this.pos));
  }
  finalize() {
    qe(this, vr, bs).call(this, this.pos), R(this, _r).buffer = R(this, Kn).slice(0, Math.max(R(this, Ui), this.pos));
  }
};
...
bs = function(n) {
  let e = R(this, Kn).byteLength;
  for (; e < n; )
    e *= 2;
  if (e === R(this, Kn).byteLength)
    return;
  let t = new ArrayBuffer(e), i = new Uint8Array(t);
  i.set(R(this, ki), 0), wt(this, Kn, t), wt(this, ki, i);
};
var fm = 2 ** 24, hm = 2, Ni, Hn, Fi, bn, Wt, wr, Es, Gs, Io, Vs, No, Oi, Cr, ks = class extends Fo {
  constructor(n) {
    super(), Ge(this, wr), Ge(this, Gs), Ge(this, Vs), Ge(this, Oi), Ge(this, Ni, void 0), Ge(this, Hn, []), Ge(this, Fi, void 0), Ge(this, bn, void 0), Ge(this, Wt, []), wt(this, Ni, n), wt(this, Fi, n.options?.chunked ?? !1), wt(this, bn, n.options?.chunkSize ?? fm);
  }
  write(n) {
    R(this, Hn).push({
      data: n.slice(),
  ...
  flush() {
    ...
    for (let t of n) {
      ...
      R(this, Fi) ? (qe(this, wr, Es).call(this, t.data, t.start), qe(this, Oi, Cr).call(this)) : R(this, Ni).options.onData?.(t.data, t.start);
    }
    R(this, Hn).length = 0;
  }
  finalize() {
    R(this, Fi) && qe(this, Oi, Cr).call(this, !0);
  }
};
...
Es = function(n, e) {
  ...
  t === -1 && (t = qe(this, Vs, No).call(this, e));
  ...
  if (qe(this, Gs, Io).call(this, i, a), i.written[0].start === 0 && i.written[0].end === R(this, bn) && (i.shouldFlush = !0), R(this, Wt).length > hm) {
    for (let o = 0; o < R(this, Wt).length - 1; o++)
      R(this, Wt)[o].shouldFlush = !0;
    qe(this, Oi, Cr).call(this);
  }
  s.byteLength < n.byteLength && qe(this, wr, Es).call(this, n.subarray(s.byteLength), e + s.byteLength);
};
...
var pm = class extends ks {
...
}, ys = 1e3, mm = ["avc", "hevc", "vp9", "av1"], xm = ["aac", "opus"], gm = 2082844800, _m = ["strict", "offset", "cross-track-offset"], Ee, De, Rr, Ht, Rt, At, mi, gi, Hs, Wn, Xn, Bi, Ts, Oo, As, Bo, Ws, zo, ws, Go, Xs, Vo, Sr, Cs, on, vn, qs, ko, zi, Pr, Dr, Ys, Mi, Yi, Mr, Rs, vm = class {
  constructor(n) {
    if (Ge(this, Ts), Ge(this, As), Ge(this, Ws), Ge(this, ws), Ge(this, Xs), Ge(this, Sr), Ge(this, on), Ge(this, qs), Ge(this, zi), Ge(this, Dr), Ge(this, Mi), Ge(this, Mr), Ge(this, Ee, void 0), Ge(this, De, void 0), Ge(this, Rr, void 0), Ge(this, Ht, void 0), Ge(this, Rt, null), Ge(this, At, null), Ge(this, mi, Math.floor(Date.now() / 1e3) + gm), Ge(this, gi, []), Ge(this, Hs, 1), Ge(this, Wn, []), Ge(this, Xn, []), Ge(this, Bi, !1), qe(this, Ts, Oo).call(this, n), n.video = Ii(n.video), n.audio = Ii(n.audio), n.fastStart = Ii(n.fastStart), this.target = n.target, wt(this, Ee, {
      firstTimestampBehavior: "strict",
      ...n
    }), n.target instanceof Lo)
      wt(this, De, new um(n.target));
    else if (n.target instanceof Uo)
      wt(this, De, new ks(n.target));
    else if (n.target instanceof dm)
      wt(this, De, new pm(n.target));
    else
      throw new Error(`Invalid target: ${n.target}`);
    qe(this, ws, Go).call(this), qe(this, As, Bo).call(this);
  }
  ...
  addVideoChunkRaw(n, e, t, i, r, s) {
    ...
    if (qe(this, Mr, Rs).call(this), !R(this, Ee).video)
      throw new Error("No video track declared.");
    if (typeof R(this, Ee).fastStart == "object" && R(this, Rt).samples.length === R(this, Ee).fastStart.expectedVideoChunks)
      throw new Error(`Cannot add more video chunks than specified in 'fastStart' (${R(this, Ee).fastStart.expectedVideoChunks}).`);
    let a = qe(this, Sr, Cs).call(this, R(this, Rt), n, e, t, i, r, s);
    if (R(this, Ee).fastStart === "fragmented" && R(this, At)) {
  ...
  addAudioChunkRaw(n, e, t, i, r) {
    ...
    if (qe(this, Mr, Rs).call(this), !R(this, Ee).audio)
      throw new Error("No audio track declared.");
    if (typeof R(this, Ee).fastStart == "object" && R(this, At).samples.length === R(this, Ee).fastStart.expectedAudioChunks)
      throw new Error(`Cannot add more audio chunks than specified in 'fastStart' (${R(this, Ee).fastStart.expectedAudioChunks}).`);
    let s = qe(this, Sr, Cs).call(this, R(this, At), n, e, t, i, r);
    if (R(this, Ee).fastStart === "fragmented" && R(this, Rt)) {
  ...
  finalize() {
    ...
    if (R(this, Ee).fastStart === "fragmented") {
      for (let e of R(this, Wn))
        qe(this, on, vn).call(this, R(this, Rt), e);
      for (let e of R(this, Xn))
        qe(this, on, vn).call(this, R(this, At), e);
      qe(this, Dr, Ys).call(this, !1);
    } else
      R(this, Rt) && qe(this, zi, Pr).call(this, R(this, Rt)), R(this, At) && qe(this, zi, Pr).call(this, R(this, At));
    let n = [R(this, Rt), R(this, At)].filter(Boolean);
    if (R(this, Ee).fastStart === "in-memory") {
      let e;
      for (let i = 0; i < 2; i++) {
        let r = gr(n, R(this, mi)), s = R(this, De).measureBox(r);
        e = R(this, De).measureBox(R(this, Ht));
        let a = R(this, De).pos + s + e;
        for (let o of R(this, gi)) {
          o.offset = a;
      ...
      let i = gr(n, R(this, mi));
      if (typeof R(this, Ee).fastStart == "object") {
        R(this, De).seek(R(this, Rr)), R(this, De).writeBox(i);
        let r = e - R(this, De).pos;
        R(this, De).writeBox(gp(r));
      } else
        R(this, De).writeBox(i);
    }
    qe(this, Mi, Yi).call(this), R(this, De).finalize(), wt(this, Bi, !0);
  }
};
...
Oo = function(n) {
  ...
  if (n.firstTimestampBehavior && !_m.includes(n.firstTimestampBehavior))
...
Bo = function() {
  if (R(this, De).writeBox(xp({
    holdsAvc: R(this, Ee).video?.codec === "avc",
    fragmented: R(this, Ee).fastStart === "fragmented"
  })), wt(this, Rr, R(this, De).pos), R(this, Ee).fastStart === "in-memory")
    wt(this, Ht, Ms(!1));
  else if (R(this, Ee).fastStart !== "fragmented") {
    if (typeof R(this, Ee).fastStart == "object") {
      let n = qe(this, Ws, zo).call(this);
      R(this, De).seek(R(this, De).pos + n);
    }
    wt(this, Ht, Ms(!0)), R(this, De).writeBox(R(this, Ht));
  }
  qe(this, Mi, Yi).call(this);
};
...
zo = function() {
  if (typeof R(this, Ee).fastStart != "object")
    return;
  let n = 0, e = [
    R(this, Ee).fastStart.expectedVideoChunks,
    R(this, Ee).fastStart.expectedAudioChunks
  ];
  for (let t of e)
...
ws = /* @__PURE__ */ new WeakSet();
Go = function() {
  if (R(this, Ee).video && wt(this, Rt, {
    id: 1,
    info: {
      type: "video",
      codec: R(this, Ee).video.codec,
      width: R(this, Ee).video.width,
      height: R(this, Ee).video.height,
      rotation: R(this, Ee).video.rotation ?? 0,
      decoderConfig: null
    },
    // The fallback contains many common frame rates as factors
    timescale: R(this, Ee).video.frameRate ?? 57600,
    samples: [],
    finalizedChunks: [],
    currentChunk: null,
  ...
  }), R(this, Ee).audio && (wt(this, At, {
    id: R(this, Ee).video ? 2 : 1,
    info: {
      type: "audio",
      codec: R(this, Ee).audio.codec,
      numberOfChannels: R(this, Ee).audio.numberOfChannels,
      sampleRate: R(this, Ee).audio.sampleRate,
      decoderConfig: null
    },
    timescale: R(this, Ee).audio.sampleRate,
    samples: [],
    finalizedChunks: [],
    currentChunk: null,
    firstDecodeTimestamp: void 0,
    ...
    lastSample: null,
    compactlyCodedChunkTable: []
  }), R(this, Ee).audio.codec === "aac")) {
    let n = qe(this, Xs, Vo).call(
      this,
      2,
      // Object type for AAC-LC, since it's the most common
      R(this, Ee).audio.sampleRate,
      R(this, Ee).audio.numberOfChannels
    );
...
Cs = function(n, e, t, i, r, s, a) {
  let o = i / 1e6, l = (i - (a ?? 0)) / 1e6, c = r / 1e6, d = qe(this, qs, ko).call(this, o, l, n);
...
vn = function(n, e) {
  R(this, Ee).fastStart !== "fragmented" && n.samples.push(e);
  ...
  if (n.lastTimescaleUnits !== null) {
    ...
    if (n.lastTimescaleUnits += s, n.lastSample.timescaleUnitsToNextSample = s, R(this, Ee).fastStart !== "fragmented") {
    ...
    n.lastTimescaleUnits = 0, R(this, Ee).fastStart !== "fragmented" && (n.timeToSampleTable.push({
      sampleCount: 1,
  ...
  if (!n.currentChunk)
    ...
    if (R(this, Ee).fastStart === "fragmented") {
      ...
      const a = R(this, Ee).minFragmentDuration ?? 1;
      n === s && e.type === "key" && r >= a && (i = !0, qe(this, Dr, Ys).call(this));
    } else
      i = r >= 0.5;
  }
  i && (n.currentChunk && qe(this, zi, Pr).call(this, n), n.currentChunk = {
...
ko = function(n, e, t) {
  const i = R(this, Ee).firstTimestampBehavior === "strict", r = t.lastDecodeTimestamp === -1;
  if (i && r && e !== 0)
    throw new Error(
...
`
  ...
  if (R(this, Ee).firstTimestampBehavior === "offset" || R(this, Ee).firstTimestampBehavior === "cross-track-offset") {
    t.firstDecodeTimestamp === void 0 && (t.firstDecodeTimestamp = e);
    let a;
    R(this, Ee).firstTimestampBehavior === "offset" ? a = t.firstDecodeTimestamp : a = Math.min(
...
Pr = function(n) {
  ...
  if (n.currentChunk) {
    if (n.finalizedChunks.push(n.currentChunk), R(this, gi).push(n.currentChunk), (n.compactlyCodedChunkTable.length === 0 || Ar(n.compactlyCodedChunkTable).samplesPerChunk !== n.currentChunk.samples.length) && n.compactlyCodedChunkTable.push({
      firstChunk: n.finalizedChunks.length,
      // 1-indexed
      samplesPerChunk: n.currentChunk.samples.length
    }), R(this, Ee).fastStart === "in-memory") {
...
Ys = function(n = !0) {
  ...
  let t = hp(this, Hs)._++;
  if (t === 1) {
    let o = gr(e, R(this, mi), !0);
    R(this, De).writeBox(o);
  }
  let i = R(this, De).pos, r = Ja(t, e);
  ...
  for (let o of e)
    o.finalizedChunks.push(o.currentChunk), R(this, gi).push(o.currentChunk), o.currentChunk = null;
  n && qe(this, Mi, Yi).call(this);
};
Mi = /* @__PURE__ */ new WeakSet();
Yi = function() {
  R(this, De) instanceof ks && R(this, De).flush();
};
...
async function Em({ canvas: n, run: e, fps: t = 30 }) {
  ...
  if (typeof VideoEncoder < "u") {
    const i = n.width, r = n.height, s = "avc1.640028", a = "vp09.00.10.08", o = await Qa(s, i, r, t), l = !o && await Qa(a, i, r, t);
    if (o || l)
      return ym({ canvas: n, run: e, fps: t, useAvc: o });
  }
  if (Mm())
    return Tm({ canvas: n, run: e, fps: t });
  throw new Error(
    "recordVideo: neither WebCodecs (VideoEncoder) nor MediaRecorder/captureStream is available in this environment"
  );
}
async function ym({ canvas: n, run: e, fps: t, useAvc: i }) {
  const r = n.width, s = n.height, a = i ? "avc1.640028" : "vp09.00.10.08", o = new Lo(), l = new vm({
    target: o,
    video: {
      codec: i ? "avc" : "vp9",
      width: r,
...
async function Tm({ canvas: n, run: e, fps: t }) {
  const i = n.captureStream(t), r = bm(), s = new MediaRecorder(i, r ? { mimeType: r } : void 0), a = [];
  s.ondataavailable = (l) => {
...
class Am {
  ...
  constructor(e, t) {
    ...
    this.container = e, this.scene = t, this.stage = new cp(e, t), this._ro = null, this._ready = this.stage.init().then(() => (this.stage.render(), typeof ResizeObserver < "u" && (this._ro = new ResizeObserver((i) => {
      for (const r of i) {
  ...
  async setView(e) {
    return await this._ready, this.stage.setView(e), this.stage.render(), this;
  }
  /**
  ...
  seek(e) {
    ...
    return this.stage.applyFrameState(xr(this.scene, t, this.stage.camera.aspect), t), this.stage.render(), this;
  }
  ...
  async transition(e, t = {}) {
    ...
    const { startMorph: r } = dp(i);
    this.stage.applyFrameState(xr(this.scene, r, this.stage.camera.aspect), r), this.stage.render(), this._cancelTransition?.();
    const s = Za(this.scene, (a) => {
      const o = this._morphFromGaps(a.gaps);
      this.stage.applyFrameState(a, o), this.stage.render();
    }, { kind: i, onProgress: t.onProgress });
    this._cancelTransition = s.cancel, this.container.dispatchEvent?.(new CustomEvent("transitionstart", { detail: { kind: i } }));
    try {
      await s.promise, this.container.dispatchEvent?.(new CustomEvent("transitionend", { detail: { kind: i } }));
    } finally {
  ...
  async toVideo(e = {}) {
    ...
    const i = this.scene.transition?.fps ?? 30, r = this.stage.renderer.domElement;
    return Em({
      canvas: r,
      fps: i,
      run: async (s) => {
        await Za(this.scene, (o) => {
          const l = this._morphFromGaps(o.gaps);
          this.stage.applyFrameState(o, l), this.stage.render(), s(o);
        }, { kind: t }).promise;
      }
    });
  }
  ...
  scrollspy(e = {}) {
    ...
    const r = this.scene.transition?.easing ?? "easeInOutCubic", s = this.scene.transition?.duration ?? 3, a = this.scene.transition?.wait ?? 0, o = (l) => {
      ...
      this.stage.applyFrameState(xr(this.scene, c, this.stage.camera.aspect), c), this.stage.render();
    };
    return o(0), this._scrollspy?.disconnect?.(), this._scrollspy = fp({
      trigger: i,
  ...
  _scrollMorph(e, t, i, r, s) {
    const a = To(e, { duration: r, wait: s });
    return Ao(a, t, (o) => Eo(i, o));
  }
  /** Tear down the three.js stage, stop animations/scrollspy, remove the canvas. */
  destroy() {
    this._cancelTransition?.(), this._scrollspy?.disconnect?.(), this._ro?.disconnect?.(), this._ro = null, this.stage?.dispose();
  }
}
class wm extends HTMLElement {
  ...
  async _mount() {
    if (!this._mounting) {
      ...
      try {
        this._stax?.destroy(), this._stax = null;
        const e = this._config ?? this.getAttribute("scene");
        if (!e) return;
        const t = typeof document < "u" ? document.baseURI : void 0, i = await Vh(e, { baseUrl: t }), r = this.getAttribute("view") || i.view || "expanded";
        if (i.view = r, this._stax = new Am(this, i), await this._stax.ready, (this.getAttribute("mode") || "static") === "scrollspy") {
          const a = this.getAttribute("trigger"), o = a ? document.querySelector(a) : this;
          this._stax.scrollspy({ trigger: o });
        }
...
typeof customElements < "u" && !customElements.get("vexy-stax") && customElements.define("vexy-stax", wm);
export {
  wm as VexyStaxElement
};

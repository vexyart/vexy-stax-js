...
`https://cdn.jsdelivr.net/npm/vexy-stax-js@3.1.4/dist/vexy-stax.element.js` (Web Component / ESM) and `https://cdn.jsdelivr.net/npm/vexy-stax-js@3.1.4/dist/vexy-stax.global.js` (global script) — pinned to v3.1.4.

...
**Tests**: 223/223 passing, 96%+ coverage on core utilities
...
npm run test:unit             # Run unit tests only (223 tests)
...
tests/                   # 16 test suites, 223 tests (includes cross-module integration)
